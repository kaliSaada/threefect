...
`)+`
`+u);const y=A+f+a,E=A+u+o,I=ms(r,r.VERTEX_SHADER,y),C=ms(r,r.FRAGMENT_SHADER,E);r.attachShader(x,I),r.attachShader(x,C),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function R(w){if(i.debug.checkShaderErrors){const V=r.getProgramInfoLog(x).trim(),G=r.getShaderInfoLog(I).trim(),W=r.getShaderInfoLog(C).trim();let K=!0,k=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,x,I,C);else{const J=gs(r,I,"vertex"),z=gs(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
Program Info Log: `+V+`
`+J+`
`+z)}else V!==""?console.warn("THREE.WebGLProgram: Program Info Log:",V):(G===""||W==="")&&(k=!1);k&&(w.diagnostics={runnable:K,programLog:V,vertexShader:{log:G,prefix:f},fragmentShader:{log:W,prefix:u}})}r.deleteShader(I),r.deleteShader(C),U=new Ti(r,x),S=Fc(r,x)}let U;this.getUniforms=function(){return U===void 0&&R(this),U};let S;this.getAttributes=function(){return S===void 0&&R(this),S};let M=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=r.getProgramParameter(x,bc)),M},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Rc++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=I,this.fragmentShader=C,this}let Yc=0;class $c{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Kc(e),t.set(e,n)),n}}class Kc{constructor(e){this.id=Yc++,this.code=e,this.usedTimes=0}}function Zc(i,e,t,n,r,s,a){const o=new zi,l=new $c,c=new Set,h=[],d=r.logarithmicDepthBuffer,p=r.vertexTextures;let m=r.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(S){return c.add(S),S===0?"uv":`uv${S}`}function f(S,M,w,V,G){const W=V.fog,K=G.geometry,k=S.isMeshStandardMaterial?V.environment:null,J=(S.isMeshStandardMaterial?t:e).get(S.envMap||k),z=J&&J.mapping===306?J.image.height:null,ne=_[S.type];S.precision!==null&&(m=r.getMaxPrecision(S.precision),m!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",m,"instead."));const le=K.morphAttributes.position||K.morphAttributes.normal||K.morphAttributes.color,ge=le!==void 0?le.length:0;let Le=0;K.morphAttributes.position!==void 0&&(Le=1),K.morphAttributes.normal!==void 0&&(Le=2),K.morphAttributes.color!==void 0&&(Le=3);let Ke,q,ee,me;if(ne){const qe=Bt[ne];Ke=qe.vertexShader,q=qe.fragmentShader}else Ke=S.vertexShader,q=S.fragmentShader,l.update(S),ee=l.getVertexShaderID(S),me=l.getFragmentShaderID(S);const se=i.getRenderTarget(),Te=i.state.buffers.depth.getReversed(),Re=G.isInstancedMesh===!0,Ue=G.isBatchedMesh===!0,Qe=!!S.map,Be=!!S.matcap,rt=!!J,b=!!S.aoMap,bt=!!S.lightMap,Fe=!!S.bumpMap,Ne=!!S.normalMap,ve=!!S.displacementMap,je=!!S.emissiveMap,xe=!!S.metalnessMap,T=!!S.roughnessMap,g=S.anisotropy>0,F=S.clearcoat>0,Y=S.dispersion>0,Z=S.iridescence>0,X=S.sheen>0,_e=S.transmission>0,ae=g&&!!S.anisotropyMap,he=F&&!!S.clearcoatMap,Ge=F&&!!S.clearcoatNormalMap,Q=F&&!!S.clearcoatRoughnessMap,de=Z&&!!S.iridescenceMap,Ee=Z&&!!S.iridescenceThicknessMap,ye=X&&!!S.sheenColorMap,fe=X&&!!S.sheenRoughnessMap,Oe=!!S.specularMap,De=!!S.specularColorMap,Ze=!!S.specularIntensityMap,P=_e&&!!S.transmissionMap,ie=_e&&!!S.thicknessMap,H=!!S.gradientMap,$=!!S.alphaMap,ce=S.alphaTest>0,oe=!!S.alphaHash,we=!!S.extensions;let tt=0;S.toneMapped&&(se===null||se.isXRRenderTarget===!0)&&(tt=i.toneMapping);const ft={shaderID:ne,shaderType:S.type,shaderName:S.name,vertexShader:Ke,fragmentShader:q,defines:S.defines,customVertexShaderID:ee,customFragmentShaderID:me,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:m,batching:Ue,batchingColor:Ue&&G._colorsTexture!==null,instancing:Re,instancingColor:Re&&G.instanceColor!==null,instancingMorph:Re&&G.morphTexture!==null,supportsVertexTextures:p,outputColorSpace:se===null?i.outputColorSpace:se.isXRRenderTarget===!0?se.texture.colorSpace:gn,alphaToCoverage:!!S.alphaToCoverage,map:Qe,matcap:Be,envMap:rt,envMapMode:rt&&J.mapping,envMapCubeUVHeight:z,aoMap:b,lightMap:bt,bumpMap:Fe,normalMap:Ne,displacementMap:p&&ve,emissiveMap:je,normalMapObjectSpace:Ne&&S.normalMapType===1,normalMapTangentSpace:Ne&&S.normalMapType===0,metalnessMap:xe,roughnessMap:T,anisotropy:g,anisotropyMap:ae,clearcoat:F,clearcoatMap:he,clearcoatNormalMap:Ge,clearcoatRoughnessMap:Q,dispersion:Y,iridescence:Z,iridescenceMap:de,iridescenceThicknessMap:Ee,sheen:X,sheenColorMap:ye,sheenRoughnessMap:fe,specularMap:Oe,specularColorMap:De,specularIntensityMap:Ze,transmission:_e,transmissionMap:P,thicknessMap:ie,gradientMap:H,opaque:S.transparent===!1&&S.blending===1&&S.alphaToCoverage===!1,alphaMap:$,alphaTest:ce,alphaHash:oe,combine:S.combine,mapUv:Qe&&x(S.map.channel),aoMapUv:b&&x(S.aoMap.channel),lightMapUv:bt&&x(S.lightMap.channel),bumpMapUv:Fe&&x(S.bumpMap.channel),normalMapUv:Ne&&x(S.normalMap.channel),displacementMapUv:ve&&x(S.displacementMap.channel),emissiveMapUv:je&&x(S.emissiveMap.channel),metalnessMapUv:xe&&x(S.metalnessMap.channel),roughnessMapUv:T&&x(S.roughnessMap.channel),anisotropyMapUv:ae&&x(S.anisotropyMap.channel),clearcoatMapUv:he&&x(S.clearcoatMap.channel),clearcoatNormalMapUv:Ge&&x(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Q&&x(S.clearcoatRoughnessMap.channel),iridescenceMapUv:de&&x(S.iridescenceMap.channel),iridescenceThicknessMapUv:Ee&&x(S.iridescenceThicknessMap.channel),sheenColorMapUv:ye&&x(S.sheenColorMap.channel),sheenRoughnessMapUv:fe&&x(S.sheenRoughnessMap.channel),specularMapUv:Oe&&x(S.specularMap.channel),specularColorMapUv:De&&x(S.specularColorMap.channel),specularIntensityMapUv:Ze&&x(S.specularIntensityMap.channel),transmissionMapUv:P&&x(S.transmissionMap.channel),thicknessMapUv:ie&&x(S.thicknessMap.channel),alphaMapUv:$&&x(S.alphaMap.channel),vertexTangents:!!K.attributes.tangent&&(Ne||g),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!K.attributes.color&&K.attributes.color.itemSize===4,pointsUvs:G.isPoints===!0&&!!K.attributes.uv&&(Qe||$),fog:!!W,useFog:S.fog===!0,fogExp2:!!W&&W.isFogExp2,flatShading:S.flatShading===!0,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:d,reverseDepthBuffer:Te,skinning:G.isSkinnedMesh===!0,morphTargets:K.morphAttributes.position!==void 0,morphNormals:K.morphAttributes.normal!==void 0,morphColors:K.morphAttributes.color!==void 0,morphTargetsCount:ge,morphTextureStride:Le,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:S.dithering,shadowMapEnabled:i.shadowMap.enabled&&w.length>0,shadowMapType:i.shadowMap.type,toneMapping:tt,decodeVideoTexture:Qe&&S.map.isVideoTexture===!0&&He.getTransfer(S.map.colorSpace)===Ye,decodeVideoTextureEmissive:je&&S.emissiveMap.isVideoTexture===!0&&He.getTransfer(S.emissiveMap.colorSpace)===Ye,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===2,flipSided:S.side===1,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:we&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(we&&S.extensions.multiDraw===!0||Ue)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return ft.vertexUv1s=c.has(1),ft.vertexUv2s=c.has(2),ft.vertexUv3s=c.has(3),c.clear(),ft}function u(S){const M=[];if(S.shaderID?M.push(S.shaderID):(M.push(S.customVertexShaderID),M.push(S.customFragmentShaderID)),S.defines!==void 0)for(const w in S.defines)M.push(w),M.push(S.defines[w]);return S.isRawShaderMaterial===!1&&(A(M,S),y(M,S),M.push(i.outputColorSpace)),M.push(S.customProgramCacheKey),M.join()}function A(S,M){S.push(M.precision),S.push(M.outputColorSpace),S.push(M.envMapMode),S.push(M.envMapCubeUVHeight),S.push(M.mapUv),S.push(M.alphaMapUv),S.push(M.lightMapUv),S.push(M.aoMapUv),S.push(M.bumpMapUv),S.push(M.normalMapUv),S.push(M.displacementMapUv),S.push(M.emissiveMapUv),S.push(M.metalnessMapUv),S.push(M.roughnessMapUv),S.push(M.anisotropyMapUv),S.push(M.clearcoatMapUv),S.push(M.clearcoatNormalMapUv),S.push(M.clearcoatRoughnessMapUv),S.push(M.iridescenceMapUv),S.push(M.iridescenceThicknessMapUv),S.push(M.sheenColorMapUv),S.push(M.sheenRoughnessMapUv),S.push(M.specularMapUv),S.push(M.specularColorMapUv),S.push(M.specularIntensityMapUv),S.push(M.transmissionMapUv),S.push(M.thicknessMapUv),S.push(M.combine),S.push(M.fogExp2),S.push(M.sizeAttenuation),S.push(M.morphTargetsCount),S.push(M.morphAttributeCount),S.push(M.numDirLights),S.push(M.numPointLights),S.push(M.numSpotLights),S.push(M.numSpotLightMaps),S.push(M.numHemiLights),S.push(M.numRectAreaLights),S.push(M.numDirLightShadows),S.push(M.numPointLightShadows),S.push(M.numSpotLightShadows),S.push(M.numSpotLightShadowsWithMaps),S.push(M.numLightProbes),S.push(M.shadowMapType),S.push(M.toneMapping),S.push(M.numClippingPlanes),S.push(M.numClipIntersection),S.push(M.depthPacking)}function y(S,M){o.disableAll(),M.supportsVertexTextures&&o.enable(0),M.instancing&&o.enable(1),M.instancingColor&&o.enable(2),M.instancingMorph&&o.enable(3),M.matcap&&o.enable(4),M.envMap&&o.enable(5),M.normalMapObjectSpace&&o.enable(6),M.normalMapTangentSpace&&o.enable(7),M.clearcoat&&o.enable(8),M.iridescence&&o.enable(9),M.alphaTest&&o.enable(10),M.vertexColors&&o.enable(11),M.vertexAlphas&&o.enable(12),M.vertexUv1s&&o.enable(13),M.vertexUv2s&&o.enable(14),M.vertexUv3s&&o.enable(15),M.vertexTangents&&o.enable(16),M.anisotropy&&o.enable(17),M.alphaHash&&o.enable(18),M.batching&&o.enable(19),M.dispersion&&o.enable(20),M.batchingColor&&o.enable(21),S.push(o.mask),o.disableAll(),M.fog&&o.enable(0),M.useFog&&o.enable(1),M.flatShading&&o.enable(2),M.logarithmicDepthBuffer&&o.enable(3),M.reverseDepthBuffer&&o.enable(4),M.skinning&&o.enable(5),M.morphTargets&&o.enable(6),M.morphNormals&&o.enable(7),M.morphColors&&o.enable(8),M.premultipliedAlpha&&o.enable(9),M.shadowMapEnabled&&o.enable(10),M.doubleSided&&o.enable(11),M.flipSided&&o.enable(12),M.useDepthPacking&&o.enable(13),M.dithering&&o.enable(14),M.transmission&&o.enable(15),M.sheen&&o.enable(16),M.opaque&&o.enable(17),M.pointsUvs&&o.enable(18),M.decodeVideoTexture&&o.enable(19),M.decodeVideoTextureEmissive&&o.enable(20),M.alphaToCoverage&&o.enable(21),S.push(o.mask)}function E(S){const M=_[S.type];let w;if(M){const V=Bt[M];w=ea.clone(V.uniforms)}else w=S.uniforms;return w}function I(S,M){let w;for(let V=0,G=h.length;V<G;V++){const W=h[V];if(W.cacheKey===M){w=W,++w.usedTimes;break}}return w===void 0&&(w=new qc(i,M,S,s),h.push(w)),w}function C(S){if(--S.usedTimes===0){const M=h.indexOf(S);h[M]=h[h.length-1],h.pop(),S.destroy()}}function R(S){l.remove(S)}function U(){l.dispose()}return{getParameters:f,getProgramCacheKey:u,getUniforms:E,acquireProgram:I,releaseProgram:C,releaseShaderCache:R,programs:h,dispose:U}}function jc(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function r(a,o,l){i.get(a)[o]=l}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function Jc(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Es(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Ts(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function a(d,p,m,_,x,f){let u=i[e];return u===void 0?(u={id:d.id,object:d,geometry:p,material:m,groupOrder:_,renderOrder:d.renderOrder,z:x,group:f},i[e]=u):(u.id=d.id,u.object=d,u.geometry=p,u.material=m,u.groupOrder=_,u.renderOrder=d.renderOrder,u.z=x,u.group=f),e++,u}function o(d,p,m,_,x,f){const u=a(d,p,m,_,x,f);m.transmission>0?n.push(u):m.transparent===!0?r.push(u):t.push(u)}function l(d,p,m,_,x,f){const u=a(d,p,m,_,x,f);m.transmission>0?n.unshift(u):m.transparent===!0?r.unshift(u):t.unshift(u)}function c(d,p){t.length>1&&t.sort(d||Jc),n.length>1&&n.sort(p||Es),r.length>1&&r.sort(p||Es)}function h(){for(let d=e,p=i.length;d<p;d++){const m=i[d];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:o,unshift:l,finish:h,sort:c}}function Qc(){let i=new WeakMap;function e(n,r){const s=i.get(n);let a;return s===void 0?(a=new Ts,i.set(n,[a])):r>=s.length?(a=new Ts,s.push(a)):a=s[r],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function eu(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new N,color:new ke};break;case"SpotLight":t={position:new N,direction:new N,color:new ke,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new N,color:new ke,distance:0,decay:0};break;case"HemisphereLight":t={direction:new N,skyColor:new ke,groundColor:new ke};break;case"RectAreaLight":t={color:new ke,position:new N,halfWidth:new N,halfHeight:new N};break}return i[e.id]=t,t}}}function tu(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $e};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $e};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new $e,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let nu=0;function iu(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function ru(i){const e=new eu,t=tu(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new N);const r=new N,s=new et,a=new et;function o(c){let h=0,d=0,p=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let m=0,_=0,x=0,f=0,u=0,A=0,y=0,E=0,I=0,C=0,R=0;c.sort(iu);for(let S=0,M=c.length;S<M;S++){const w=c[S],V=w.color,G=w.intensity,W=w.distance,K=w.shadow&&w.shadow.map?w.shadow.map.texture:null;if(w.isAmbientLight)h+=V.r*G,d+=V.g*G,p+=V.b*G;else if(w.isLightProbe){for(let k=0;k<9;k++)n.probe[k].addScaledVector(w.sh.coefficients[k],G);R++}else if(w.isDirectionalLight){const k=e.get(w);if(k.color.copy(w.color).multiplyScalar(w.intensity),w.castShadow){const J=w.shadow,z=t.get(w);z.shadowIntensity=J.intensity,z.shadowBias=J.bias,z.shadowNormalBias=J.normalBias,z.shadowRadius=J.radius,z.shadowMapSize=J.mapSize,n.directionalShadow[m]=z,n.directionalShadowMap[m]=K,n.directionalShadowMatrix[m]=w.shadow.matrix,A++}n.directional[m]=k,m++}else if(w.isSpotLight){const k=e.get(w);k.position.setFromMatrixPosition(w.matrixWorld),k.color.copy(V).multiplyScalar(G),k.distance=W,k.coneCos=Math.cos(w.angle),k.penumbraCos=Math.cos(w.angle*(1-w.penumbra)),k.decay=w.decay,n.spot[x]=k;const J=w.shadow;if(w.map&&(n.spotLightMap[I]=w.map,I++,J.updateMatrices(w),w.castShadow&&C++),n.spotLightMatrix[x]=J.matrix,w.castShadow){const z=t.get(w);z.shadowIntensity=J.intensity,z.shadowBias=J.bias,z.shadowNormalBias=J.normalBias,z.shadowRadius=J.radius,z.shadowMapSize=J.mapSize,n.spotShadow[x]=z,n.spotShadowMap[x]=K,E++}x++}else if(w.isRectAreaLight){const k=e.get(w);k.color.copy(V).multiplyScalar(G),k.halfWidth.set(w.width*.5,0,0),k.halfHeight.set(0,w.height*.5,0),n.rectArea[f]=k,f++}else if(w.isPointLight){const k=e.get(w);if(k.color.copy(w.color).multiplyScalar(w.intensity),k.distance=w.distance,k.decay=w.decay,w.castShadow){const J=w.shadow,z=t.get(w);z.shadowIntensity=J.intensity,z.shadowBias=J.bias,z.shadowNormalBias=J.normalBias,z.shadowRadius=J.radius,z.shadowMapSize=J.mapSize,z.shadowCameraNear=J.camera.near,z.shadowCameraFar=J.camera.far,n.pointShadow[_]=z,n.pointShadowMap[_]=K,n.pointShadowMatrix[_]=w.shadow.matrix,y++}n.point[_]=k,_++}else if(w.isHemisphereLight){const k=e.get(w);k.skyColor.copy(w.color).multiplyScalar(G),k.groundColor.copy(w.groundColor).multiplyScalar(G),n.hemi[u]=k,u++}}f>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=te.LTC_FLOAT_1,n.rectAreaLTC2=te.LTC_FLOAT_2):(n.rectAreaLTC1=te.LTC_HALF_1,n.rectAreaLTC2=te.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=p;const U=n.hash;(U.directionalLength!==m||U.pointLength!==_||U.spotLength!==x||U.rectAreaLength!==f||U.hemiLength!==u||U.numDirectionalShadows!==A||U.numPointShadows!==y||U.numSpotShadows!==E||U.numSpotMaps!==I||U.numLightProbes!==R)&&(n.directional.length=m,n.spot.length=x,n.rectArea.length=f,n.point.length=_,n.hemi.length=u,n.directionalShadow.length=A,n.directionalShadowMap.length=A,n.pointShadow.length=y,n.pointShadowMap.length=y,n.spotShadow.length=E,n.spotShadowMap.length=E,n.directionalShadowMatrix.length=A,n.pointShadowMatrix.length=y,n.spotLightMatrix.length=E+I-C,n.spotLightMap.length=I,n.numSpotLightShadowsWithMaps=C,n.numLightProbes=R,U.directionalLength=m,U.pointLength=_,U.spotLength=x,U.rectAreaLength=f,U.hemiLength=u,U.numDirectionalShadows=A,U.numPointShadows=y,U.numSpotShadows=E,U.numSpotMaps=I,U.numLightProbes=R,n.version=nu++)}function l(c,h){let d=0,p=0,m=0,_=0,x=0;const f=h.matrixWorldInverse;for(let u=0,A=c.length;u<A;u++){const y=c[u];if(y.isDirectionalLight){const E=n.directional[d];E.direction.setFromMatrixPosition(y.matrixWorld),r.setFromMatrixPosition(y.target.matrixWorld),E.direction.sub(r),E.direction.transformDirection(f),d++}else if(y.isSpotLight){const E=n.spot[m];E.position.setFromMatrixPosition(y.matrixWorld),E.position.applyMatrix4(f),E.direction.setFromMatrixPosition(y.matrixWorld),r.setFromMatrixPosition(y.target.matrixWorld),E.direction.sub(r),E.direction.transformDirection(f),m++}else if(y.isRectAreaLight){const E=n.rectArea[_];E.position.setFromMatrixPosition(y.matrixWorld),E.position.applyMatrix4(f),a.identity(),s.copy(y.matrixWorld),s.premultiply(f),a.extractRotation(s),E.halfWidth.set(y.width*.5,0,0),E.halfHeight.set(0,y.height*.5,0),E.halfWidth.applyMatrix4(a),E.halfHeight.applyMatrix4(a),_++}else if(y.isPointLight){const E=n.point[p];E.position.setFromMatrixPosition(y.matrixWorld),E.position.applyMatrix4(f),p++}else if(y.isHemisphereLight){const E=n.hemi[x];E.direction.setFromMatrixPosition(y.matrixWorld),E.direction.transformDirection(f),x++}}}return{setup:o,setupView:l,state:n}}function ys(i){const e=new ru(i),t=[],n=[];function r(h){c.camera=h,t.length=0,n.length=0}function s(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function l(h){e.setupView(t,h)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function su(i){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new ys(i),e.set(r,[o])):s>=a.length?(o=new ys(i),a.push(o)):o=a[s],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const au=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function lu(i,e,t){let n=new Hr;const r=new $e,s=new $e,a=new it,o=new ua({depthPacking:3201}),l=new ha,c={},h=t.maxTextureSize,d={0:1,1:0,2:2},p=new Yt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $e},radius:{value:4}},vertexShader:au,fragmentShader:ou}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const _=new Nt;_.setAttribute("position",new Ft(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Ot(_,p),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=1;let u=this.type;this.render=function(C,R,U){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||C.length===0)return;const S=i.getRenderTarget(),M=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),V=i.state;V.setBlending(0),V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);const G=u!==3&&this.type===3,W=u===3&&this.type!==3;for(let K=0,k=C.length;K<k;K++){const J=C[K],z=J.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const ne=z.getFrameExtents();if(r.multiply(ne),s.copy(z.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/ne.x),r.x=s.x*ne.x,z.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/ne.y),r.y=s.y*ne.y,z.mapSize.y=s.y)),z.map===null||G===!0||W===!0){const ge=this.type!==3?{minFilter:1003,magFilter:1003}:{};z.map!==null&&z.map.dispose(),z.map=new sn(r.x,r.y,ge),z.map.texture.name=J.name+".shadowMap",z.camera.updateProjectionMatrix()}i.setRenderTarget(z.map),i.clear();const le=z.getViewportCount();for(let ge=0;ge<le;ge++){const Le=z.getViewport(ge);a.set(s.x*Le.x,s.y*Le.y,s.x*Le.z,s.y*Le.w),V.viewport(a),z.updateMatrices(J,ge),n=z.getFrustum(),E(R,U,z.camera,J,this.type)}z.isPointLightShadow!==!0&&this.type===3&&A(z,U),z.needsUpdate=!1}u=this.type,f.needsUpdate=!1,i.setRenderTarget(S,M,w)};function A(C,R){const U=e.update(x);p.defines.VSM_SAMPLES!==C.blurSamples&&(p.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new sn(r.x,r.y)),p.uniforms.shadow_pass.value=C.map.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(R,null,U,p,x,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(R,null,U,m,x,null)}function y(C,R,U,S){let M=null;const w=U.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(w!==void 0)M=w;else if(M=U.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const V=M.uuid,G=R.uuid;let W=c[V];W===void 0&&(W={},c[V]=W);let K=W[G];K===void 0&&(K=M.clone(),W[G]=K,R.addEventListener("dispose",I)),M=K}if(M.visible=R.visible,M.wireframe=R.wireframe,S===3?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:d[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,U.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const V=i.properties.get(M);V.light=U}return M}function E(C,R,U,S,M){if(C.visible===!1)return;if(C.layers.test(R.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&M===3)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,C.matrixWorld);const G=e.update(C),W=C.material;if(Array.isArray(W)){const K=G.groups;for(let k=0,J=K.length;k<J;k++){const z=K[k],ne=W[z.materialIndex];if(ne&&ne.visible){const le=y(C,ne,S,M);C.onBeforeShadow(i,C,R,U,G,le,z),i.renderBufferDirect(U,null,G,le,C,z),C.onAfterShadow(i,C,R,U,G,le,z)}}}else if(W.visible){const K=y(C,W,S,M);C.onBeforeShadow(i,C,R,U,G,K,null),i.renderBufferDirect(U,null,G,K,C,null),C.onAfterShadow(i,C,R,U,G,K,null)}}const V=C.children;for(let G=0,W=V.length;G<W;G++)E(V[G],R,U,S,M)}function I(C){C.target.removeEventListener("dispose",I);for(const U in c){const S=c[U],M=C.target.uuid;M in S&&(S[M].dispose(),delete S[M])}}}const cu={0:1,2:6,4:7,3:5,1:0,6:2,7:4,5:3};function uu(i,e){function t(){let P=!1;const ie=new it;let H=null;const $=new it(0,0,0,0);return{setMask:function(ce){H!==ce&&!P&&(i.colorMask(ce,ce,ce,ce),H=ce)},setLocked:function(ce){P=ce},setClear:function(ce,oe,we,tt,ft){ft===!0&&(ce*=tt,oe*=tt,we*=tt),ie.set(ce,oe,we,tt),$.equals(ie)===!1&&(i.clearColor(ce,oe,we,tt),$.copy(ie))},reset:function(){P=!1,H=null,$.set(-1,0,0,0)}}}function n(){let P=!1,ie=!1,H=null,$=null,ce=null;return{setReversed:function(oe){if(ie!==oe){const we=e.get("EXT_clip_control");ie?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT);const tt=ce;ce=null,this.setClear(tt)}ie=oe},getReversed:function(){return ie},setTest:function(oe){oe?se(i.DEPTH_TEST):Te(i.DEPTH_TEST)},setMask:function(oe){H!==oe&&!P&&(i.depthMask(oe),H=oe)},setFunc:function(oe){if(ie&&(oe=cu[oe]),$!==oe){switch(oe){case 0:i.depthFunc(i.NEVER);break;case 1:i.depthFunc(i.ALWAYS);break;case 2:i.depthFunc(i.LESS);break;case 3:i.depthFunc(i.LEQUAL);break;case 4:i.depthFunc(i.EQUAL);break;case 5:i.depthFunc(i.GEQUAL);break;case 6:i.depthFunc(i.GREATER);break;case 7:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}$=oe}},setLocked:function(oe){P=oe},setClear:function(oe){ce!==oe&&(ie&&(oe=1-oe),i.clearDepth(oe),ce=oe)},reset:function(){P=!1,H=null,$=null,ce=null,ie=!1}}}function r(){let P=!1,ie=null,H=null,$=null,ce=null,oe=null,we=null,tt=null,ft=null;return{setTest:function(qe){P||(qe?se(i.STENCIL_TEST):Te(i.STENCIL_TEST))},setMask:function(qe){ie!==qe&&!P&&(i.stencilMask(qe),ie=qe)},setFunc:function(qe,Ut,$t){(H!==qe||$!==Ut||ce!==$t)&&(i.stencilFunc(qe,Ut,$t),H=qe,$=Ut,ce=$t)},setOp:function(qe,Ut,$t){(oe!==qe||we!==Ut||tt!==$t)&&(i.stencilOp(qe,Ut,$t),oe=qe,we=Ut,tt=$t)},setLocked:function(qe){P=qe},setClear:function(qe){ft!==qe&&(i.clearStencil(qe),ft=qe)},reset:function(){P=!1,ie=null,H=null,$=null,ce=null,oe=null,we=null,tt=null,ft=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let h={},d={},p=new WeakMap,m=[],_=null,x=!1,f=null,u=null,A=null,y=null,E=null,I=null,C=null,R=new ke(0,0,0),U=0,S=!1,M=null,w=null,V=null,G=null,W=null;const K=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,J=0;const z=i.getParameter(i.VERSION);z.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(z)[1]),k=J>=1):z.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),k=J>=2);let ne=null,le={};const ge=i.getParameter(i.SCISSOR_BOX),Le=i.getParameter(i.VIEWPORT),Ke=new it().fromArray(ge),q=new it().fromArray(Le);function ee(P,ie,H,$){const ce=new Uint8Array(4),oe=i.createTexture();i.bindTexture(P,oe),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let we=0;we<H;we++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(ie,0,i.RGBA,1,1,$,0,i.RGBA,i.UNSIGNED_BYTE,ce):i.texImage2D(ie+we,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ce);return oe}const me={};me[i.TEXTURE_2D]=ee(i.TEXTURE_2D,i.TEXTURE_2D,1),me[i.TEXTURE_CUBE_MAP]=ee(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),me[i.TEXTURE_2D_ARRAY]=ee(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),me[i.TEXTURE_3D]=ee(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),se(i.DEPTH_TEST),a.setFunc(3),Fe(!1),Ne(1),se(i.CULL_FACE),b(0);function se(P){h[P]!==!0&&(i.enable(P),h[P]=!0)}function Te(P){h[P]!==!1&&(i.disable(P),h[P]=!1)}function Re(P,ie){return d[P]!==ie?(i.bindFramebuffer(P,ie),d[P]=ie,P===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ie),P===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ie),!0):!1}function Ue(P,ie){let H=m,$=!1;if(P){H=p.get(ie),H===void 0&&(H=[],p.set(ie,H));const ce=P.textures;if(H.length!==ce.length||H[0]!==i.COLOR_ATTACHMENT0){for(let oe=0,we=ce.length;oe<we;oe++)H[oe]=i.COLOR_ATTACHMENT0+oe;H.length=ce.length,$=!0}}else H[0]!==i.BACK&&(H[0]=i.BACK,$=!0);$&&i.drawBuffers(H)}function Qe(P){return _!==P?(i.useProgram(P),_=P,!0):!1}const Be={100:i.FUNC_ADD,101:i.FUNC_SUBTRACT,102:i.FUNC_REVERSE_SUBTRACT};Be[103]=i.MIN,Be[104]=i.MAX;const rt={200:i.ZERO,201:i.ONE,202:i.SRC_COLOR,204:i.SRC_ALPHA,210:i.SRC_ALPHA_SATURATE,208:i.DST_COLOR,206:i.DST_ALPHA,203:i.ONE_MINUS_SRC_COLOR,205:i.ONE_MINUS_SRC_ALPHA,209:i.ONE_MINUS_DST_COLOR,207:i.ONE_MINUS_DST_ALPHA,211:i.CONSTANT_COLOR,212:i.ONE_MINUS_CONSTANT_COLOR,213:i.CONSTANT_ALPHA,214:i.ONE_MINUS_CONSTANT_ALPHA};function b(P,ie,H,$,ce,oe,we,tt,ft,qe){if(P===0){x===!0&&(Te(i.BLEND),x=!1);return}if(x===!1&&(se(i.BLEND),x=!0),P!==5){if(P!==f||qe!==S){if((u!==100||E!==100)&&(i.blendEquation(i.FUNC_ADD),u=100,E=100),qe)switch(P){case 1:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFunc(i.ONE,i.ONE);break;case 3:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case 4:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case 1:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case 3:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case 4:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}A=null,y=null,I=null,C=null,R.set(0,0,0),U=0,f=P,S=qe}return}ce=ce||ie,oe=oe||H,we=we||$,(ie!==u||ce!==E)&&(i.blendEquationSeparate(Be[ie],Be[ce]),u=ie,E=ce),(H!==A||$!==y||oe!==I||we!==C)&&(i.blendFuncSeparate(rt[H],rt[$],rt[oe],rt[we]),A=H,y=$,I=oe,C=we),(tt.equals(R)===!1||ft!==U)&&(i.blendColor(tt.r,tt.g,tt.b,ft),R.copy(tt),U=ft),f=P,S=!1}function bt(P,ie){P.side===2?Te(i.CULL_FACE):se(i.CULL_FACE);let H=P.side===1;ie&&(H=!H),Fe(H),P.blending===1&&P.transparent===!1?b(0):b(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const $=P.stencilWrite;o.setTest($),$&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),je(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?se(i.SAMPLE_ALPHA_TO_COVERAGE):Te(i.SAMPLE_ALPHA_TO_COVERAGE)}function Fe(P){M!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),M=P)}function Ne(P){P!==0?(se(i.CULL_FACE),P!==w&&(P===1?i.cullFace(i.BACK):P===2?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Te(i.CULL_FACE),w=P}function ve(P){P!==V&&(k&&i.lineWidth(P),V=P)}function je(P,ie,H){P?(se(i.POLYGON_OFFSET_FILL),(G!==ie||W!==H)&&(i.polygonOffset(ie,H),G=ie,W=H)):Te(i.POLYGON_OFFSET_FILL)}function xe(P){P?se(i.SCISSOR_TEST):Te(i.SCISSOR_TEST)}function T(P){P===void 0&&(P=i.TEXTURE0+K-1),ne!==P&&(i.activeTexture(P),ne=P)}function g(P,ie,H){H===void 0&&(ne===null?H=i.TEXTURE0+K-1:H=ne);let $=le[H];$===void 0&&($={type:void 0,texture:void 0},le[H]=$),($.type!==P||$.texture!==ie)&&(ne!==H&&(i.activeTexture(H),ne=H),i.bindTexture(P,ie||me[P]),$.type=P,$.texture=ie)}function F(){const P=le[ne];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function Y(){try{i.compressedTexImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Z(){try{i.compressedTexImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function X(){try{i.texSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function _e(){try{i.texSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ae(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function he(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ge(){try{i.texStorage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Q(){try{i.texStorage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function de(){try{i.texImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ee(){try{i.texImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ye(P){Ke.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Ke.copy(P))}function fe(P){q.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),q.copy(P))}function Oe(P,ie){let H=c.get(ie);H===void 0&&(H=new WeakMap,c.set(ie,H));let $=H.get(P);$===void 0&&($=i.getUniformBlockIndex(ie,P.name),H.set(P,$))}function De(P,ie){const $=c.get(ie).get(P);l.get(ie)!==$&&(i.uniformBlockBinding(ie,$,P.__bindingPointIndex),l.set(ie,$))}function Ze(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},ne=null,le={},d={},p=new WeakMap,m=[],_=null,x=!1,f=null,u=null,A=null,y=null,E=null,I=null,C=null,R=new ke(0,0,0),U=0,S=!1,M=null,w=null,V=null,G=null,W=null,Ke.set(0,0,i.canvas.width,i.canvas.height),q.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:se,disable:Te,bindFramebuffer:Re,drawBuffers:Ue,useProgram:Qe,setBlending:b,setMaterial:bt,setFlipSided:Fe,setCullFace:Ne,setLineWidth:ve,setPolygonOffset:je,setScissorTest:xe,activeTexture:T,bindTexture:g,unbindTexture:F,compressedTexImage2D:Y,compressedTexImage3D:Z,texImage2D:de,texImage3D:Ee,updateUBOMapping:Oe,uniformBlockBinding:De,texStorage2D:Ge,texStorage3D:Q,texSubImage2D:X,texSubImage3D:_e,compressedTexSubImage2D:ae,compressedTexSubImage3D:he,scissor:ye,viewport:fe,reset:Ze}}function hu(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $e,h=new WeakMap;let d;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,g){return m?new OffscreenCanvas(T,g):zn("canvas")}function x(T,g,F){let Y=1;const Z=xe(T);if((Z.width>F||Z.height>F)&&(Y=F/Math.max(Z.width,Z.height)),Y<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const X=Math.floor(Y*Z.width),_e=Math.floor(Y*Z.height);d===void 0&&(d=_(X,_e));const ae=g?_(X,_e):d;return ae.width=X,ae.height=_e,ae.getContext("2d").drawImage(T,0,0,X,_e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+X+"x"+_e+")."),ae}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),T;return T}function f(T){return T.generateMipmaps}function u(T){i.generateMipmap(T)}function A(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function y(T,g,F,Y,Z=!1){if(T!==null){if(i[T]!==void 0)return i[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let X=g;if(g===i.RED&&(F===i.FLOAT&&(X=i.R32F),F===i.HALF_FLOAT&&(X=i.R16F),F===i.UNSIGNED_BYTE&&(X=i.R8)),g===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(X=i.R8UI),F===i.UNSIGNED_SHORT&&(X=i.R16UI),F===i.UNSIGNED_INT&&(X=i.R32UI),F===i.BYTE&&(X=i.R8I),F===i.SHORT&&(X=i.R16I),F===i.INT&&(X=i.R32I)),g===i.RG&&(F===i.FLOAT&&(X=i.RG32F),F===i.HALF_FLOAT&&(X=i.RG16F),F===i.UNSIGNED_BYTE&&(X=i.RG8)),g===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(X=i.RG8UI),F===i.UNSIGNED_SHORT&&(X=i.RG16UI),F===i.UNSIGNED_INT&&(X=i.RG32UI),F===i.BYTE&&(X=i.RG8I),F===i.SHORT&&(X=i.RG16I),F===i.INT&&(X=i.RG32I)),g===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(X=i.RGB8UI),F===i.UNSIGNED_SHORT&&(X=i.RGB16UI),F===i.UNSIGNED_INT&&(X=i.RGB32UI),F===i.BYTE&&(X=i.RGB8I),F===i.SHORT&&(X=i.RGB16I),F===i.INT&&(X=i.RGB32I)),g===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),F===i.UNSIGNED_INT&&(X=i.RGBA32UI),F===i.BYTE&&(X=i.RGBA8I),F===i.SHORT&&(X=i.RGBA16I),F===i.INT&&(X=i.RGBA32I)),g===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),g===i.RGBA){const _e=Z?Jn:He.getTransfer(Y);F===i.FLOAT&&(X=i.RGBA32F),F===i.HALF_FLOAT&&(X=i.RGBA16F),F===i.UNSIGNED_BYTE&&(X=_e===Ye?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function E(T,g){let F;return T?g===null||g===1014||g===1020?F=i.DEPTH24_STENCIL8:g===1015?F=i.DEPTH32F_STENCIL8:g===1012&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===1014||g===1020?F=i.DEPTH_COMPONENT24:g===1015?F=i.DEPTH_COMPONENT32F:g===1012&&(F=i.DEPTH_COMPONENT16),F}function I(T,g){return f(T)===!0||T.isFramebufferTexture&&T.minFilter!==1003&&T.minFilter!==1006?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function C(T){const g=T.target;g.removeEventListener("dispose",C),U(g),g.isVideoTexture&&h.delete(g)}function R(T){const g=T.target;g.removeEventListener("dispose",R),M(g)}function U(T){const g=n.get(T);if(g.__webglInit===void 0)return;const F=T.source,Y=p.get(F);if(Y){const Z=Y[g.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&S(T),Object.keys(Y).length===0&&p.delete(F)}n.remove(T)}function S(T){const g=n.get(T);i.deleteTexture(g.__webglTexture);const F=T.source,Y=p.get(F);delete Y[g.__cacheKey],a.memory.textures--}function M(T){const g=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(g.__webglFramebuffer[Y]))for(let Z=0;Z<g.__webglFramebuffer[Y].length;Z++)i.deleteFramebuffer(g.__webglFramebuffer[Y][Z]);else i.deleteFramebuffer(g.__webglFramebuffer[Y]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[Y])}else{if(Array.isArray(g.__webglFramebuffer))for(let Y=0;Y<g.__webglFramebuffer.length;Y++)i.deleteFramebuffer(g.__webglFramebuffer[Y]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let Y=0;Y<g.__webglColorRenderbuffer.length;Y++)g.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[Y]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const F=T.textures;for(let Y=0,Z=F.length;Y<Z;Y++){const X=n.get(F[Y]);X.__webglTexture&&(i.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(F[Y])}n.remove(T)}let w=0;function V(){w=0}function G(){const T=w;return T>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+r.maxTextures),w+=1,T}function W(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function K(T,g){const F=n.get(T);if(T.isVideoTexture&&ve(T),T.isRenderTargetTexture===!1&&T.version>0&&F.__version!==T.version){const Y=T.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{q(F,T,g);return}}t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+g)}function k(T,g){const F=n.get(T);if(T.version>0&&F.__version!==T.version){q(F,T,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+g)}function J(T,g){const F=n.get(T);if(T.version>0&&F.__version!==T.version){q(F,T,g);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+g)}function z(T,g){const F=n.get(T);if(T.version>0&&F.__version!==T.version){ee(F,T,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+g)}const ne={1e3:i.REPEAT,1001:i.CLAMP_TO_EDGE,1002:i.MIRRORED_REPEAT},le={1003:i.NEAREST,1004:i.NEAREST_MIPMAP_NEAREST,1005:i.NEAREST_MIPMAP_LINEAR,1006:i.LINEAR,1007:i.LINEAR_MIPMAP_NEAREST,1008:i.LINEAR_MIPMAP_LINEAR},ge={512:i.NEVER,519:i.ALWAYS,513:i.LESS,515:i.LEQUAL,514:i.EQUAL,518:i.GEQUAL,516:i.GREATER,517:i.NOTEQUAL};function Le(T,g){if(g.type===1015&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===1006||g.magFilter===1007||g.magFilter===1005||g.magFilter===1008||g.minFilter===1006||g.minFilter===1007||g.minFilter===1005||g.minFilter===1008)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,ne[g.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,ne[g.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,ne[g.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,le[g.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,le[g.minFilter]),g.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,ge[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===1003||g.minFilter!==1005&&g.minFilter!==1008||g.type===1015&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Ke(T,g){let F=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",C));const Y=g.source;let Z=p.get(Y);Z===void 0&&(Z={},p.set(Y,Z));const X=W(g);if(X!==T.__cacheKey){Z[X]===void 0&&(Z[X]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),Z[X].usedTimes++;const _e=Z[T.__cacheKey];_e!==void 0&&(Z[T.__cacheKey].usedTimes--,_e.usedTimes===0&&S(g)),T.__cacheKey=X,T.__webglTexture=Z[X].texture}return F}function q(T,g,F){let Y=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Y=i.TEXTURE_3D);const Z=Ke(T,g),X=g.source;t.bindTexture(Y,T.__webglTexture,i.TEXTURE0+F);const _e=n.get(X);if(X.version!==_e.__version||Z===!0){t.activeTexture(i.TEXTURE0+F);const ae=He.getPrimaries(He.workingColorSpace),he=g.colorSpace===Zt?null:He.getPrimaries(g.colorSpace),Ge=g.colorSpace===Zt||ae===he?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ge);let Q=x(g.image,!1,r.maxTextureSize);Q=je(g,Q);const de=s.convert(g.format,g.colorSpace),Ee=s.convert(g.type);let ye=y(g.internalFormat,de,Ee,g.colorSpace,g.isVideoTexture);Le(Y,g);let fe;const Oe=g.mipmaps,De=g.isVideoTexture!==!0,Ze=_e.__version===void 0||Z===!0,P=X.dataReady,ie=I(g,Q);if(g.isDepthTexture)ye=E(g.format===1027,g.type),Ze&&(De?t.texStorage2D(i.TEXTURE_2D,1,ye,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,ye,Q.width,Q.height,0,de,Ee,null));else if(g.isDataTexture)if(Oe.length>0){De&&Ze&&t.texStorage2D(i.TEXTURE_2D,ie,ye,Oe[0].width,Oe[0].height);for(let H=0,$=Oe.length;H<$;H++)fe=Oe[H],De?P&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,fe.width,fe.height,de,Ee,fe.data):t.texImage2D(i.TEXTURE_2D,H,ye,fe.width,fe.height,0,de,Ee,fe.data);g.generateMipmaps=!1}else De?(Ze&&t.texStorage2D(i.TEXTURE_2D,ie,ye,Q.width,Q.height),P&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Q.width,Q.height,de,Ee,Q.data)):t.texImage2D(i.TEXTURE_2D,0,ye,Q.width,Q.height,0,de,Ee,Q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){De&&Ze&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ie,ye,Oe[0].width,Oe[0].height,Q.depth);for(let H=0,$=Oe.length;H<$;H++)if(fe=Oe[H],g.format!==1023)if(de!==null)if(De){if(P)if(g.layerUpdates.size>0){const ce=Kr(fe.width,fe.height,g.format,g.type);for(const oe of g.layerUpdates){const we=fe.data.subarray(oe*ce/fe.data.BYTES_PER_ELEMENT,(oe+1)*ce/fe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,oe,fe.width,fe.height,1,de,we)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,fe.width,fe.height,Q.depth,de,fe.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,H,ye,fe.width,fe.height,Q.depth,0,fe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else De?P&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,H,0,0,0,fe.width,fe.height,Q.depth,de,Ee,fe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,H,ye,fe.width,fe.height,Q.depth,0,de,Ee,fe.data)}else{De&&Ze&&t.texStorage2D(i.TEXTURE_2D,ie,ye,Oe[0].width,Oe[0].height);for(let H=0,$=Oe.length;H<$;H++)fe=Oe[H],g.format!==1023?de!==null?De?P&&t.compressedTexSubImage2D(i.TEXTURE_2D,H,0,0,fe.width,fe.height,de,fe.data):t.compressedTexImage2D(i.TEXTURE_2D,H,ye,fe.width,fe.height,0,fe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?P&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,fe.width,fe.height,de,Ee,fe.data):t.texImage2D(i.TEXTURE_2D,H,ye,fe.width,fe.height,0,de,Ee,fe.data)}else if(g.isDataArrayTexture)if(De){if(Ze&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ie,ye,Q.width,Q.height,Q.depth),P)if(g.layerUpdates.size>0){const H=Kr(Q.width,Q.height,g.format,g.type);for(const $ of g.layerUpdates){const ce=Q.data.subarray($*H/Q.data.BYTES_PER_ELEMENT,($+1)*H/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,$,Q.width,Q.height,1,de,Ee,ce)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,de,Ee,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ye,Q.width,Q.height,Q.depth,0,de,Ee,Q.data);else if(g.isData3DTexture)De?(Ze&&t.texStorage3D(i.TEXTURE_3D,ie,ye,Q.width,Q.height,Q.depth),P&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,de,Ee,Q.data)):t.texImage3D(i.TEXTURE_3D,0,ye,Q.width,Q.height,Q.depth,0,de,Ee,Q.data);else if(g.isFramebufferTexture){if(Ze)if(De)t.texStorage2D(i.TEXTURE_2D,ie,ye,Q.width,Q.height);else{let H=Q.width,$=Q.height;for(let ce=0;ce<ie;ce++)t.texImage2D(i.TEXTURE_2D,ce,ye,H,$,0,de,Ee,null),H>>=1,$>>=1}}else if(Oe.length>0){if(De&&Ze){const H=xe(Oe[0]);t.texStorage2D(i.TEXTURE_2D,ie,ye,H.width,H.height)}for(let H=0,$=Oe.length;H<$;H++)fe=Oe[H],De?P&&t.texSubImage2D(i.TEXTURE_2D,H,0,0,de,Ee,fe):t.texImage2D(i.TEXTURE_2D,H,ye,de,Ee,fe);g.generateMipmaps=!1}else if(De){if(Ze){const H=xe(Q);t.texStorage2D(i.TEXTURE_2D,ie,ye,H.width,H.height)}P&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,de,Ee,Q)}else t.texImage2D(i.TEXTURE_2D,0,ye,de,Ee,Q);f(g)&&u(Y),_e.__version=X.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function ee(T,g,F){if(g.image.length!==6)return;const Y=Ke(T,g),Z=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+F);const X=n.get(Z);if(Z.version!==X.__version||Y===!0){t.activeTexture(i.TEXTURE0+F);const _e=He.getPrimaries(He.workingColorSpace),ae=g.colorSpace===Zt?null:He.getPrimaries(g.colorSpace),he=g.colorSpace===Zt||_e===ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,he);const Ge=g.isCompressedTexture||g.image[0].isCompressedTexture,Q=g.image[0]&&g.image[0].isDataTexture,de=[];for(let $=0;$<6;$++)!Ge&&!Q?de[$]=x(g.image[$],!0,r.maxCubemapSize):de[$]=Q?g.image[$].image:g.image[$],de[$]=je(g,de[$]);const Ee=de[0],ye=s.convert(g.format,g.colorSpace),fe=s.convert(g.type),Oe=y(g.internalFormat,ye,fe,g.colorSpace),De=g.isVideoTexture!==!0,Ze=X.__version===void 0||Y===!0,P=Z.dataReady;let ie=I(g,Ee);Le(i.TEXTURE_CUBE_MAP,g);let H;if(Ge){De&&Ze&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ie,Oe,Ee.width,Ee.height);for(let $=0;$<6;$++){H=de[$].mipmaps;for(let ce=0;ce<H.length;ce++){const oe=H[ce];g.format!==1023?ye!==null?De?P&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce,0,0,oe.width,oe.height,ye,oe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce,Oe,oe.width,oe.height,0,oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):De?P&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce,0,0,oe.width,oe.height,ye,fe,oe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce,Oe,oe.width,oe.height,0,ye,fe,oe.data)}}}else{if(H=g.mipmaps,De&&Ze){H.length>0&&ie++;const $=xe(de[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ie,Oe,$.width,$.height)}for(let $=0;$<6;$++)if(Q){De?P&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,de[$].width,de[$].height,ye,fe,de[$].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Oe,de[$].width,de[$].height,0,ye,fe,de[$].data);for(let ce=0;ce<H.length;ce++){const we=H[ce].image[$].image;De?P&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce+1,0,0,we.width,we.height,ye,fe,we.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce+1,Oe,we.width,we.height,0,ye,fe,we.data)}}else{De?P&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,ye,fe,de[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Oe,ye,fe,de[$]);for(let ce=0;ce<H.length;ce++){const oe=H[ce];De?P&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce+1,0,0,ye,fe,oe.image[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce+1,Oe,ye,fe,oe.image[$])}}}f(g)&&u(i.TEXTURE_CUBE_MAP),X.__version=Z.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function me(T,g,F,Y,Z,X){const _e=s.convert(F.format,F.colorSpace),ae=s.convert(F.type),he=y(F.internalFormat,_e,ae,F.colorSpace),Ge=n.get(g),Q=n.get(F);if(Q.__renderTarget=g,!Ge.__hasExternalTextures){const de=Math.max(1,g.width>>X),Ee=Math.max(1,g.height>>X);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,X,he,de,Ee,g.depth,0,_e,ae,null):t.texImage2D(Z,X,he,de,Ee,0,_e,ae,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),Ne(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,Z,Q.__webglTexture,0,Fe(g)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,Z,Q.__webglTexture,X),t.bindFramebuffer(i.FRAMEBUFFER,null)}function se(T,g,F){if(i.bindRenderbuffer(i.RENDERBUFFER,T),g.depthBuffer){const Y=g.depthTexture,Z=Y&&Y.isDepthTexture?Y.type:null,X=E(g.stencilBuffer,Z),_e=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=Fe(g);Ne(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ae,X,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,ae,X,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,X,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,_e,i.RENDERBUFFER,T)}else{const Y=g.textures;for(let Z=0;Z<Y.length;Z++){const X=Y[Z],_e=s.convert(X.format,X.colorSpace),ae=s.convert(X.type),he=y(X.internalFormat,_e,ae,X.colorSpace),Ge=Fe(g);F&&Ne(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ge,he,g.width,g.height):Ne(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ge,he,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,he,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Te(T,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(g.depthTexture);Y.__renderTarget=g,(!Y.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),K(g.depthTexture,0);const Z=Y.__webglTexture,X=Fe(g);if(g.depthTexture.format===1026)Ne(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0,X):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0);else if(g.depthTexture.format===1027)Ne(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0,X):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Re(T){const g=n.get(T),F=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const Y=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),Y){const Z=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,Y.removeEventListener("dispose",Z)};Y.addEventListener("dispose",Z),g.__depthDisposeCallback=Z}g.__boundDepthTexture=Y}if(T.depthTexture&&!g.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");Te(g.__webglFramebuffer,T)}else if(F){g.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[Y]),g.__webglDepthbuffer[Y]===void 0)g.__webglDepthbuffer[Y]=i.createRenderbuffer(),se(g.__webglDepthbuffer[Y],T,!1);else{const Z=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=g.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,X)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),se(g.__webglDepthbuffer,T,!1);else{const Y=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Z=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Z),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,Z)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ue(T,g,F){const Y=n.get(T);g!==void 0&&me(Y.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Re(T)}function Qe(T){const g=T.texture,F=n.get(T),Y=n.get(g);T.addEventListener("dispose",R);const Z=T.textures,X=T.isWebGLCubeRenderTarget===!0,_e=Z.length>1;if(_e||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=g.version,a.memory.textures++),X){F.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer[ae]=[];for(let he=0;he<g.mipmaps.length;he++)F.__webglFramebuffer[ae][he]=i.createFramebuffer()}else F.__webglFramebuffer[ae]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer=[];for(let ae=0;ae<g.mipmaps.length;ae++)F.__webglFramebuffer[ae]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(_e)for(let ae=0,he=Z.length;ae<he;ae++){const Ge=n.get(Z[ae]);Ge.__webglTexture===void 0&&(Ge.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&Ne(T)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let ae=0;ae<Z.length;ae++){const he=Z[ae];F.__webglColorRenderbuffer[ae]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[ae]);const Ge=s.convert(he.format,he.colorSpace),Q=s.convert(he.type),de=y(he.internalFormat,Ge,Q,he.colorSpace,T.isXRRenderTarget===!0),Ee=Fe(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ee,de,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.RENDERBUFFER,F.__webglColorRenderbuffer[ae])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),se(F.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(X){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Le(i.TEXTURE_CUBE_MAP,g);for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0)for(let he=0;he<g.mipmaps.length;he++)me(F.__webglFramebuffer[ae][he],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,he);else me(F.__webglFramebuffer[ae],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);f(g)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let ae=0,he=Z.length;ae<he;ae++){const Ge=Z[ae],Q=n.get(Ge);t.bindTexture(i.TEXTURE_2D,Q.__webglTexture),Le(i.TEXTURE_2D,Ge),me(F.__webglFramebuffer,T,Ge,i.COLOR_ATTACHMENT0+ae,i.TEXTURE_2D,0),f(Ge)&&u(i.TEXTURE_2D)}t.unbindTexture()}else{let ae=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ae=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,Y.__webglTexture),Le(ae,g),g.mipmaps&&g.mipmaps.length>0)for(let he=0;he<g.mipmaps.length;he++)me(F.__webglFramebuffer[he],T,g,i.COLOR_ATTACHMENT0,ae,he);else me(F.__webglFramebuffer,T,g,i.COLOR_ATTACHMENT0,ae,0);f(g)&&u(ae),t.unbindTexture()}T.depthBuffer&&Re(T)}function Be(T){const g=T.textures;for(let F=0,Y=g.length;F<Y;F++){const Z=g[F];if(f(Z)){const X=A(T),_e=n.get(Z).__webglTexture;t.bindTexture(X,_e),u(X),t.unbindTexture()}}}const rt=[],b=[];function bt(T){if(T.samples>0){if(Ne(T)===!1){const g=T.textures,F=T.width,Y=T.height;let Z=i.COLOR_BUFFER_BIT;const X=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,_e=n.get(T),ae=g.length>1;if(ae)for(let he=0;he<g.length;he++)t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let he=0;he<g.length;he++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),ae){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,_e.__webglColorRenderbuffer[he]);const Ge=n.get(g[he]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ge,0)}i.blitFramebuffer(0,0,F,Y,0,0,F,Y,Z,i.NEAREST),l===!0&&(rt.length=0,b.length=0,rt.push(i.COLOR_ATTACHMENT0+he),T.depthBuffer&&T.resolveDepthBuffer===!1&&(rt.push(X),b.push(X),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,b)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,rt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ae)for(let he=0;he<g.length;he++){t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.RENDERBUFFER,_e.__webglColorRenderbuffer[he]);const Ge=n.get(g[he]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,_e.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.TEXTURE_2D,Ge,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Fe(T){return Math.min(r.maxSamples,T.samples)}function Ne(T){const g=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function ve(T){const g=a.render.frame;h.get(T)!==g&&(h.set(T,g),T.update())}function je(T,g){const F=T.colorSpace,Y=T.format,Z=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||F!==gn&&F!==Zt&&(He.getTransfer(F)===Ye?(Y!==1023||Z!==1009)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),g}function xe(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=V,this.setTexture2D=K,this.setTexture2DArray=k,this.setTexture3D=J,this.setTextureCube=z,this.rebindTextures=Ue,this.setupRenderTarget=Qe,this.updateRenderTargetMipmap=Be,this.updateMultisampleRenderTarget=bt,this.setupDepthRenderbuffer=Re,this.setupFrameBufferTexture=me,this.useMultisampledRTT=Ne}function du(i,e){function t(n,r=Zt){let s;const a=He.getTransfer(r);if(n===1009)return i.UNSIGNED_BYTE;if(n===1017)return i.UNSIGNED_SHORT_4_4_4_4;if(n===1018)return i.UNSIGNED_SHORT_5_5_5_1;if(n===35902)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===1010)return i.BYTE;if(n===1011)return i.SHORT;if(n===1012)return i.UNSIGNED_SHORT;if(n===1013)return i.INT;if(n===1014)return i.UNSIGNED_INT;if(n===1015)return i.FLOAT;if(n===1016)return i.HALF_FLOAT;if(n===1021)return i.ALPHA;if(n===1022)return i.RGB;if(n===1023)return i.RGBA;if(n===1024)return i.LUMINANCE;if(n===1025)return i.LUMINANCE_ALPHA;if(n===1026)return i.DEPTH_COMPONENT;if(n===1027)return i.DEPTH_STENCIL;if(n===1028)return i.RED;if(n===1029)return i.RED_INTEGER;if(n===1030)return i.RG;if(n===1031)return i.RG_INTEGER;if(n===1033)return i.RGBA_INTEGER;if(n===33776||n===33777||n===33778||n===33779)if(a===Ye)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===33776)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===33776)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===35840||n===35841||n===35842||n===35843)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===35840)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===35841)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===35842)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===35843)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===36196||n===37492||n===37496)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===36196||n===37492)return a===Ye?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===37496)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===37808||n===37809||n===37810||n===37811||n===37812||n===37813||n===37814||n===37815||n===37816||n===37817||n===37818||n===37819||n===37820||n===37821)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===37808)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===37809)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===37810)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===37811)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===37812)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===37813)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===37814)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===37815)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===37816)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===37817)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===37818)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===37819)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===37820)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===37821)return a===Ye?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===36492||n===36494||n===36495)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===36492)return a===Ye?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===36494)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===36495)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===36283||n===36284||n===36285||n===36286)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===36492)return s.COMPRESSED_RED_RGTC1_EXT;if(n===36284)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===36285)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===36286)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===1020?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const fu={type:"move"};class hr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new xi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new xi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new xi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const x of e.hand.values()){const f=t.getJointPose(x,n),u=this._getHandJoint(c,x);f!==null&&(u.matrix.fromArray(f.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=f.radius),u.visible=f!==null}const h=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],p=h.position.distanceTo(d.position),m=.02,_=.005;c.inputState.pinching&&p>m+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=m-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(fu)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new xi;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const pu=`
void main() {
...
}`;class _u{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const r=new pt,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!=n.depthNear||t.depthFar!=n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Yt({vertexShader:pu,fragmentShader:mu,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ot(new Kn(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class gu extends vn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,h=null,d=null,p=null,m=null,_=null;const x=new _u,f=t.getContextAttributes();let u=null,A=null;const y=[],E=[],I=new $e;let C=null;const R=new At;R.viewport=new it;const U=new At;U.viewport=new it;const S=[R,U],M=new _a;let w=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let ee=y[q];return ee===void 0&&(ee=new hr,y[q]=ee),ee.getTargetRaySpace()},this.getControllerGrip=function(q){let ee=y[q];return ee===void 0&&(ee=new hr,y[q]=ee),ee.getGripSpace()},this.getHand=function(q){let ee=y[q];return ee===void 0&&(ee=new hr,y[q]=ee),ee.getHandSpace()};function G(q){const ee=E.indexOf(q.inputSource);if(ee===-1)return;const me=y[ee];me!==void 0&&(me.update(q.inputSource,q.frame,c||a),me.dispatchEvent({type:q.type,data:q.inputSource}))}function W(){r.removeEventListener("select",G),r.removeEventListener("selectstart",G),r.removeEventListener("selectend",G),r.removeEventListener("squeeze",G),r.removeEventListener("squeezestart",G),r.removeEventListener("squeezeend",G),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",K);for(let q=0;q<y.length;q++){const ee=E[q];ee!==null&&(E[q]=null,y[q].disconnect(ee))}w=null,V=null,x.reset(),e.setRenderTarget(u),m=null,p=null,d=null,r=null,A=null,Ke.stop(),n.isPresenting=!1,e.setPixelRatio(C),e.setSize(I.width,I.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){s=q,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(q){c=q},this.getBaseLayer=function(){return p!==null?p:m},this.getBinding=function(){return d},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(q){if(r=q,r!==null){if(u=e.getRenderTarget(),r.addEventListener("select",G),r.addEventListener("selectstart",G),r.addEventListener("selectend",G),r.addEventListener("squeeze",G),r.addEventListener("squeezestart",G),r.addEventListener("squeezeend",G),r.addEventListener("end",W),r.addEventListener("inputsourceschange",K),f.xrCompatible!==!0&&await t.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(I),r.renderState.layers===void 0){const ee={antialias:f.antialias,alpha:!0,depth:f.depth,stencil:f.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,ee),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),A=new sn(m.framebufferWidth,m.framebufferHeight,{format:1023,type:1009,colorSpace:e.outputColorSpace,stencilBuffer:f.stencil})}else{let ee=null,me=null,se=null;f.depth&&(se=f.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ee=f.stencil?1027:1026,me=f.stencil?1020:1014);const Te={colorFormat:t.RGBA8,depthFormat:se,scaleFactor:s};d=new XRWebGLBinding(r,t),p=d.createProjectionLayer(Te),r.updateRenderState({layers:[p]}),e.setPixelRatio(1),e.setSize(p.textureWidth,p.textureHeight,!1),A=new sn(p.textureWidth,p.textureHeight,{format:1023,type:1009,depthTexture:new Wr(p.textureWidth,p.textureHeight,me,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:f.stencil,colorSpace:e.outputColorSpace,samples:f.antialias?4:0,resolveDepthBuffer:p.ignoreDepthValues===!1})}A.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Ke.setContext(r),Ke.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function K(q){for(let ee=0;ee<q.removed.length;ee++){const me=q.removed[ee],se=E.indexOf(me);se>=0&&(E[se]=null,y[se].disconnect(me))}for(let ee=0;ee<q.added.length;ee++){const me=q.added[ee];let se=E.indexOf(me);if(se===-1){for(let Re=0;Re<y.length;Re++)if(Re>=E.length){E.push(me),se=Re;break}else if(E[Re]===null){E[Re]=me,se=Re;break}if(se===-1)break}const Te=y[se];Te&&Te.connect(me)}}const k=new N,J=new N;function z(q,ee,me){k.setFromMatrixPosition(ee.matrixWorld),J.setFromMatrixPosition(me.matrixWorld);const se=k.distanceTo(J),Te=ee.projectionMatrix.elements,Re=me.projectionMatrix.elements,Ue=Te[14]/(Te[10]-1),Qe=Te[14]/(Te[10]+1),Be=(Te[9]+1)/Te[5],rt=(Te[9]-1)/Te[5],b=(Te[8]-1)/Te[0],bt=(Re[8]+1)/Re[0],Fe=Ue*b,Ne=Ue*bt,ve=se/(-b+bt),je=ve*-b;if(ee.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(je),q.translateZ(ve),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),Te[10]===-1)q.projectionMatrix.copy(ee.projectionMatrix),q.projectionMatrixInverse.copy(ee.projectionMatrixInverse);else{const xe=Ue+ve,T=Qe+ve,g=Fe-je,F=Ne+(se-je),Y=Be*Qe/T*xe,Z=rt*Qe/T*xe;q.projectionMatrix.makePerspective(g,F,Y,Z,xe,T),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function ne(q,ee){ee===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(ee.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(r===null)return;let ee=q.near,me=q.far;x.texture!==null&&(x.depthNear>0&&(ee=x.depthNear),x.depthFar>0&&(me=x.depthFar)),M.near=U.near=R.near=ee,M.far=U.far=R.far=me,(w!==M.near||V!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),w=M.near,V=M.far),R.layers.mask=q.layers.mask|2,U.layers.mask=q.layers.mask|4,M.layers.mask=R.layers.mask|U.layers.mask;const se=q.parent,Te=M.cameras;ne(M,se);for(let Re=0;Re<Te.length;Re++)ne(Te[Re],se);Te.length===2?z(M,R,U):M.projectionMatrix.copy(R.projectionMatrix),le(q,M,se)};function le(q,ee,me){me===null?q.matrix.copy(ee.matrixWorld):(q.matrix.copy(me.matrixWorld),q.matrix.invert(),q.matrix.multiply(ee.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(ee.projectionMatrix),q.projectionMatrixInverse.copy(ee.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=wi*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(p===null&&m===null))return l},this.setFoveation=function(q){l=q,p!==null&&(p.fixedFoveation=q),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=q)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(M)};let ge=null;function Le(q,ee){if(h=ee.getViewerPose(c||a),_=ee,h!==null){const me=h.views;m!==null&&(e.setRenderTargetFramebuffer(A,m.framebuffer),e.setRenderTarget(A));let se=!1;me.length!==M.cameras.length&&(M.cameras.length=0,se=!0);for(let Re=0;Re<me.length;Re++){const Ue=me[Re];let Qe=null;if(m!==null)Qe=m.getViewport(Ue);else{const rt=d.getViewSubImage(p,Ue);Qe=rt.viewport,Re===0&&(e.setRenderTargetTextures(A,rt.colorTexture,p.ignoreDepthValues?void 0:rt.depthStencilTexture),e.setRenderTarget(A))}let Be=S[Re];Be===void 0&&(Be=new At,Be.layers.enable(Re),Be.viewport=new it,S[Re]=Be),Be.matrix.fromArray(Ue.transform.matrix),Be.matrix.decompose(Be.position,Be.quaternion,Be.scale),Be.projectionMatrix.fromArray(Ue.projectionMatrix),Be.projectionMatrixInverse.copy(Be.projectionMatrix).invert(),Be.viewport.set(Qe.x,Qe.y,Qe.width,Qe.height),Re===0&&(M.matrix.copy(Be.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),se===!0&&M.cameras.push(Be)}const Te=r.enabledFeatures;if(Te&&Te.includes("depth-sensing")){const Re=d.getDepthInformation(me[0]);Re&&Re.isValid&&Re.texture&&x.init(e,Re,r.renderState)}}for(let me=0;me<y.length;me++){const se=E[me],Te=y[me];se!==null&&Te!==void 0&&Te.update(se,ee,c||a)}ge&&ge(q,ee),ee.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ee}),_=null}const Ke=new Zr;Ke.setAnimationLoop(Le),this.setAnimationLoop=function(q){ge=q},this.dispose=function(){}}}const pn=new Vt,vu=new et;function xu(i,e){function t(f,u){f.matrixAutoUpdate===!0&&f.updateMatrix(),u.value.copy(f.matrix)}function n(f,u){u.color.getRGB(f.fogColor.value,Nr(i)),u.isFog?(f.fogNear.value=u.near,f.fogFar.value=u.far):u.isFogExp2&&(f.fogDensity.value=u.density)}function r(f,u,A,y,E){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(f,u):u.isMeshToonMaterial?(s(f,u),d(f,u)):u.isMeshPhongMaterial?(s(f,u),h(f,u)):u.isMeshStandardMaterial?(s(f,u),p(f,u),u.isMeshPhysicalMaterial&&m(f,u,E)):u.isMeshMatcapMaterial?(s(f,u),_(f,u)):u.isMeshDepthMaterial?s(f,u):u.isMeshDistanceMaterial?(s(f,u),x(f,u)):u.isMeshNormalMaterial?s(f,u):u.isLineBasicMaterial?(a(f,u),u.isLineDashedMaterial&&o(f,u)):u.isPointsMaterial?l(f,u,A,y):u.isSpriteMaterial?c(f,u):u.isShadowMaterial?(f.color.value.copy(u.color),f.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(f,u){f.opacity.value=u.opacity,u.color&&f.diffuse.value.copy(u.color),u.emissive&&f.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(f.map.value=u.map,t(u.map,f.mapTransform)),u.alphaMap&&(f.alphaMap.value=u.alphaMap,t(u.alphaMap,f.alphaMapTransform)),u.bumpMap&&(f.bumpMap.value=u.bumpMap,t(u.bumpMap,f.bumpMapTransform),f.bumpScale.value=u.bumpScale,u.side===1&&(f.bumpScale.value*=-1)),u.normalMap&&(f.normalMap.value=u.normalMap,t(u.normalMap,f.normalMapTransform),f.normalScale.value.copy(u.normalScale),u.side===1&&f.normalScale.value.negate()),u.displacementMap&&(f.displacementMap.value=u.displacementMap,t(u.displacementMap,f.displacementMapTransform),f.displacementScale.value=u.displacementScale,f.displacementBias.value=u.displacementBias),u.emissiveMap&&(f.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,f.emissiveMapTransform)),u.specularMap&&(f.specularMap.value=u.specularMap,t(u.specularMap,f.specularMapTransform)),u.alphaTest>0&&(f.alphaTest.value=u.alphaTest);const A=e.get(u),y=A.envMap,E=A.envMapRotation;y&&(f.envMap.value=y,pn.copy(E),pn.x*=-1,pn.y*=-1,pn.z*=-1,y.isCubeTexture&&y.isRenderTargetTexture===!1&&(pn.y*=-1,pn.z*=-1),f.envMapRotation.value.setFromMatrix4(vu.makeRotationFromEuler(pn)),f.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,f.reflectivity.value=u.reflectivity,f.ior.value=u.ior,f.refractionRatio.value=u.refractionRatio),u.lightMap&&(f.lightMap.value=u.lightMap,f.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,f.lightMapTransform)),u.aoMap&&(f.aoMap.value=u.aoMap,f.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,f.aoMapTransform))}function a(f,u){f.diffuse.value.copy(u.color),f.opacity.value=u.opacity,u.map&&(f.map.value=u.map,t(u.map,f.mapTransform))}function o(f,u){f.dashSize.value=u.dashSize,f.totalSize.value=u.dashSize+u.gapSize,f.scale.value=u.scale}function l(f,u,A,y){f.diffuse.value.copy(u.color),f.opacity.value=u.opacity,f.size.value=u.size*A,f.scale.value=y*.5,u.map&&(f.map.value=u.map,t(u.map,f.uvTransform)),u.alphaMap&&(f.alphaMap.value=u.alphaMap,t(u.alphaMap,f.alphaMapTransform)),u.alphaTest>0&&(f.alphaTest.value=u.alphaTest)}function c(f,u){f.diffuse.value.copy(u.color),f.opacity.value=u.opacity,f.rotation.value=u.rotation,u.map&&(f.map.value=u.map,t(u.map,f.mapTransform)),u.alphaMap&&(f.alphaMap.value=u.alphaMap,t(u.alphaMap,f.alphaMapTransform)),u.alphaTest>0&&(f.alphaTest.value=u.alphaTest)}function h(f,u){f.specular.value.copy(u.specular),f.shininess.value=Math.max(u.shininess,1e-4)}function d(f,u){u.gradientMap&&(f.gradientMap.value=u.gradientMap)}function p(f,u){f.metalness.value=u.metalness,u.metalnessMap&&(f.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,f.metalnessMapTransform)),f.roughness.value=u.roughness,u.roughnessMap&&(f.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,f.roughnessMapTransform)),u.envMap&&(f.envMapIntensity.value=u.envMapIntensity)}function m(f,u,A){f.ior.value=u.ior,u.sheen>0&&(f.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),f.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(f.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,f.sheenColorMapTransform)),u.sheenRoughnessMap&&(f.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,f.sheenRoughnessMapTransform))),u.clearcoat>0&&(f.clearcoat.value=u.clearcoat,f.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(f.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,f.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(f.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===1&&f.clearcoatNormalScale.value.negate())),u.dispersion>0&&(f.dispersion.value=u.dispersion),u.iridescence>0&&(f.iridescence.value=u.iridescence,f.iridescenceIOR.value=u.iridescenceIOR,f.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(f.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,f.iridescenceMapTransform)),u.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),u.transmission>0&&(f.transmission.value=u.transmission,f.transmissionSamplerMap.value=A.texture,f.transmissionSamplerSize.value.set(A.width,A.height),u.transmissionMap&&(f.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,f.transmissionMapTransform)),f.thickness.value=u.thickness,u.thicknessMap&&(f.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=u.attenuationDistance,f.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(f.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(f.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=u.specularIntensity,f.specularColor.value.copy(u.specularColor),u.specularColorMap&&(f.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,f.specularColorMapTransform)),u.specularIntensityMap&&(f.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,f.specularIntensityMapTransform))}function _(f,u){u.matcap&&(f.matcap.value=u.matcap)}function x(f,u){const A=e.get(u).light;f.referencePosition.value.setFromMatrixPosition(A.matrixWorld),f.nearDistance.value=A.shadow.camera.near,f.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Mu(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(A,y){const E=y.program;n.uniformBlockBinding(A,E)}function c(A,y){let E=r[A.id];E===void 0&&(_(A),E=h(A),r[A.id]=E,A.addEventListener("dispose",f));const I=y.program;n.updateUBOMapping(A,I);const C=e.render.frame;s[A.id]!==C&&(p(A),s[A.id]=C)}function h(A){const y=d();A.__bindingPointIndex=y;const E=i.createBuffer(),I=A.__size,C=A.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,I,C),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,y,E),E}function d(){for(let A=0;A<o;A++)if(a.indexOf(A)===-1)return a.push(A),A;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function p(A){const y=r[A.id],E=A.uniforms,I=A.__cache;i.bindBuffer(i.UNIFORM_BUFFER,y);for(let C=0,R=E.length;C<R;C++){const U=Array.isArray(E[C])?E[C]:[E[C]];for(let S=0,M=U.length;S<M;S++){const w=U[S];if(m(w,C,S,I)===!0){const V=w.__offset,G=Array.isArray(w.value)?w.value:[w.value];let W=0;for(let K=0;K<G.length;K++){const k=G[K],J=x(k);typeof k=="number"||typeof k=="boolean"?(w.__data[0]=k,i.bufferSubData(i.UNIFORM_BUFFER,V+W,w.__data)):k.isMatrix3?(w.__data[0]=k.elements[0],w.__data[1]=k.elements[1],w.__data[2]=k.elements[2],w.__data[3]=0,w.__data[4]=k.elements[3],w.__data[5]=k.elements[4],w.__data[6]=k.elements[5],w.__data[7]=0,w.__data[8]=k.elements[6],w.__data[9]=k.elements[7],w.__data[10]=k.elements[8],w.__data[11]=0):(k.toArray(w.__data,W),W+=J.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,V,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(A,y,E,I){const C=A.value,R=y+"_"+E;if(I[R]===void 0)return typeof C=="number"||typeof C=="boolean"?I[R]=C:I[R]=C.clone(),!0;{const U=I[R];if(typeof C=="number"||typeof C=="boolean"){if(U!==C)return I[R]=C,!0}else if(U.equals(C)===!1)return U.copy(C),!0}return!1}function _(A){const y=A.uniforms;let E=0;const I=16;for(let R=0,U=y.length;R<U;R++){const S=Array.isArray(y[R])?y[R]:[y[R]];for(let M=0,w=S.length;M<w;M++){const V=S[M],G=Array.isArray(V.value)?V.value:[V.value];for(let W=0,K=G.length;W<K;W++){const k=G[W],J=x(k),z=E%I,ne=z%J.boundary,le=z+ne;E+=ne,le!==0&&I-le<J.storage&&(E+=I-le),V.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),V.__offset=E,E+=J.storage}}}const C=E%I;return C>0&&(E+=I-C),A.__size=E,A.__cache={},this}function x(A){const y={boundary:0,storage:0};return typeof A=="number"||typeof A=="boolean"?(y.boundary=4,y.storage=4):A.isVector2?(y.boundary=8,y.storage=8):A.isVector3||A.isColor?(y.boundary=16,y.storage=12):A.isVector4?(y.boundary=16,y.storage=16):A.isMatrix3?(y.boundary=48,y.storage=48):A.isMatrix4?(y.boundary=64,y.storage=64):A.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",A),y}function f(A){const y=A.target;y.removeEventListener("dispose",f);const E=a.indexOf(y.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(r[y.id]),delete r[y.id],delete s[y.id]}function u(){for(const A in r)i.deleteBuffer(r[A]);a=[],r={},s={}}return{bind:l,update:c,dispose:u}}class Su{constructor(e={}){const{canvas:t=Us(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:p=!1}=e;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;const _=new Uint32Array(4),x=new Int32Array(4);let f=null,u=null;const A=[],y=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Tt,this.toneMapping=0,this.toneMappingExposure=1;const E=this;let I=!1,C=0,R=0,U=null,S=-1,M=null;const w=new it,V=new it;let G=null;const W=new ke(0);let K=0,k=t.width,J=t.height,z=1,ne=null,le=null;const ge=new it(0,0,k,J),Le=new it(0,0,k,J);let Ke=!1;const q=new Hr;let ee=!1,me=!1;const se=new et,Te=new et,Re=new N,Ue=new it,Qe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Be=!1;function rt(){return U===null?z:1}let b=n;function bt(v,D){return t.getContext(v,D)}try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ri}`),t.addEventListener("webglcontextlost",$,!1),t.addEventListener("webglcontextrestored",ce,!1),t.addEventListener("webglcontextcreationerror",oe,!1),b===null){const D="webgl2";if(b=bt(D,v),b===null)throw bt(D)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw console.error("THREE.WebGLRenderer: "+v.message),v}let Fe,Ne,ve,je,xe,T,g,F,Y,Z,X,_e,ae,he,Ge,Q,de,Ee,ye,fe,Oe,De,Ze,P;function ie(){Fe=new Pl(b),Fe.init(),De=new du(b,Fe),Ne=new yl(b,Fe,e,De),ve=new uu(b,Fe),Ne.reverseDepthBuffer&&p&&ve.buffers.depth.setReversed(!0),je=new Ul(b),xe=new jc,T=new hu(b,Fe,ve,xe,Ne,De,je),g=new bl(E),F=new wl(E),Y=new xa(b),Ze=new El(b,Y),Z=new Dl(b,Y,je,Ze),X=new Fl(b,Z,Y,je),ye=new Il(b,Ne,T),Q=new Al(xe),_e=new Zc(E,g,F,Fe,Ne,Ze,Q),ae=new xu(E,xe),he=new Qc,Ge=new su(Fe),Ee=new Sl(E,g,F,ve,X,m,l),de=new lu(E,X,Ne),P=new Mu(b,je,Ne,ve),fe=new Tl(b,Fe,je),Oe=new Ll(b,Fe,je),je.programs=_e.programs,E.capabilities=Ne,E.extensions=Fe,E.properties=xe,E.renderLists=he,E.shadowMap=de,E.state=ve,E.info=je}ie();const H=new gu(E,b);this.xr=H,this.getContext=function(){return b},this.getContextAttributes=function(){return b.getContextAttributes()},this.forceContextLoss=function(){const v=Fe.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Fe.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(v){v!==void 0&&(z=v,this.setSize(k,J,!1))},this.getSize=function(v){return v.set(k,J)},this.setSize=function(v,D,O=!0){if(H.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}k=v,J=D,t.width=Math.floor(v*z),t.height=Math.floor(D*z),O===!0&&(t.style.width=v+"px",t.style.height=D+"px"),this.setViewport(0,0,v,D)},this.getDrawingBufferSize=function(v){return v.set(k*z,J*z).floor()},this.setDrawingBufferSize=function(v,D,O){k=v,J=D,z=O,t.width=Math.floor(v*O),t.height=Math.floor(D*O),this.setViewport(0,0,v,D)},this.getCurrentViewport=function(v){return v.copy(w)},this.getViewport=function(v){return v.copy(ge)},this.setViewport=function(v,D,O,B){v.isVector4?ge.set(v.x,v.y,v.z,v.w):ge.set(v,D,O,B),ve.viewport(w.copy(ge).multiplyScalar(z).round())},this.getScissor=function(v){return v.copy(Le)},this.setScissor=function(v,D,O,B){v.isVector4?Le.set(v.x,v.y,v.z,v.w):Le.set(v,D,O,B),ve.scissor(V.copy(Le).multiplyScalar(z).round())},this.getScissorTest=function(){return Ke},this.setScissorTest=function(v){ve.setScissorTest(Ke=v)},this.setOpaqueSort=function(v){ne=v},this.setTransparentSort=function(v){le=v},this.getClearColor=function(v){return v.copy(Ee.getClearColor())},this.setClearColor=function(){Ee.setClearColor.apply(Ee,arguments)},this.getClearAlpha=function(){return Ee.getClearAlpha()},this.setClearAlpha=function(){Ee.setClearAlpha.apply(Ee,arguments)},this.clear=function(v=!0,D=!0,O=!0){let B=0;if(v){let L=!1;if(U!==null){const j=U.texture.format;L=j===1033||j===1031||j===1029}if(L){const j=U.texture.type,re=j===1009||j===1014||j===1012||j===1020||j===1017||j===1018,ue=Ee.getClearColor(),pe=Ee.getClearAlpha(),Ae=ue.r,be=ue.g,Me=ue.b;re?(_[0]=Ae,_[1]=be,_[2]=Me,_[3]=pe,b.clearBufferuiv(b.COLOR,0,_)):(x[0]=Ae,x[1]=be,x[2]=Me,x[3]=pe,b.clearBufferiv(b.COLOR,0,x))}else B|=b.COLOR_BUFFER_BIT}D&&(B|=b.DEPTH_BUFFER_BIT),O&&(B|=b.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),b.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",$,!1),t.removeEventListener("webglcontextrestored",ce,!1),t.removeEventListener("webglcontextcreationerror",oe,!1),Ee.dispose(),he.dispose(),Ge.dispose(),xe.dispose(),g.dispose(),F.dispose(),X.dispose(),Ze.dispose(),P.dispose(),_e.dispose(),H.dispose(),H.removeEventListener("sessionstart",As),H.removeEventListener("sessionend",bs),mn.stop()};function $(v){v.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),I=!0}function ce(){console.log("THREE.WebGLRenderer: Context Restored."),I=!1;const v=je.autoReset,D=de.enabled,O=de.autoUpdate,B=de.needsUpdate,L=de.type;ie(),je.autoReset=v,de.enabled=D,de.autoUpdate=O,de.needsUpdate=B,de.type=L}function oe(v){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function we(v){const D=v.target;D.removeEventListener("dispose",we),tt(D)}function tt(v){ft(v),xe.remove(v)}function ft(v){const D=xe.get(v).programs;D!==void 0&&(D.forEach(function(O){_e.releaseProgram(O)}),v.isShaderMaterial&&_e.releaseShaderCache(v))}this.renderBufferDirect=function(v,D,O,B,L,j){D===null&&(D=Qe);const re=L.isMesh&&L.matrixWorld.determinant()<0,ue=Au(v,D,O,B,L);ve.setMaterial(B,re);let pe=O.index,Ae=1;if(B.wireframe===!0){if(pe=Z.getWireframeAttribute(O),pe===void 0)return;Ae=2}const be=O.drawRange,Me=O.attributes.position;let ze=be.start*Ae,We=(be.start+be.count)*Ae;j!==null&&(ze=Math.max(ze,j.start*Ae),We=Math.min(We,(j.start+j.count)*Ae)),pe!==null?(ze=Math.max(ze,0),We=Math.min(We,pe.count)):Me!=null&&(ze=Math.max(ze,0),We=Math.min(We,Me.count));const at=We-ze;if(at<0||at===1/0)return;Ze.setup(L,B,ue,O,pe);let nt,Ve=fe;if(pe!==null&&(nt=Y.get(pe),Ve=Oe,Ve.setIndex(nt)),L.isMesh)B.wireframe===!0?(ve.setLineWidth(B.wireframeLinewidth*rt()),Ve.setMode(b.LINES)):Ve.setMode(b.TRIANGLES);else if(L.isLine){let Se=B.linewidth;Se===void 0&&(Se=1),ve.setLineWidth(Se*rt()),L.isLineSegments?Ve.setMode(b.LINES):L.isLineLoop?Ve.setMode(b.LINE_LOOP):Ve.setMode(b.LINE_STRIP)}else L.isPoints?Ve.setMode(b.POINTS):L.isSprite&&Ve.setMode(b.TRIANGLES);if(L.isBatchedMesh)if(L._multiDrawInstances!==null)Ve.renderMultiDrawInstances(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount,L._multiDrawInstances);else if(Fe.get("WEBGL_multi_draw"))Ve.renderMultiDraw(L._multiDrawStarts,L._multiDrawCounts,L._multiDrawCount);else{const Se=L._multiDrawStarts,ut=L._multiDrawCounts,Xe=L._multiDrawCount,It=pe?Y.get(pe).bytesPerElement:1,On=xe.get(B).currentProgram.getUniforms();for(let Et=0;Et<Xe;Et++)On.setValue(b,"_gl_DrawID",Et),Ve.render(Se[Et]/It,ut[Et])}else if(L.isInstancedMesh)Ve.renderInstances(ze,at,L.count);else if(O.isInstancedBufferGeometry){const Se=O._maxInstanceCount!==void 0?O._maxInstanceCount:1/0,ut=Math.min(O.instanceCount,Se);Ve.renderInstances(ze,at,ut)}else Ve.render(ze,at)};function qe(v,D,O){v.transparent===!0&&v.side===2&&v.forceSinglePass===!1?(v.side=1,v.needsUpdate=!0,bi(v,D,O),v.side=0,v.needsUpdate=!0,bi(v,D,O),v.side=2):bi(v,D,O)}this.compile=function(v,D,O=null){O===null&&(O=v),u=Ge.get(O),u.init(D),y.push(u),O.traverseVisible(function(L){L.isLight&&L.layers.test(D.layers)&&(u.pushLight(L),L.castShadow&&u.pushShadow(L))}),v!==O&&v.traverseVisible(function(L){L.isLight&&L.layers.test(D.layers)&&(u.pushLight(L),L.castShadow&&u.pushShadow(L))}),u.setupLights();const B=new Set;return v.traverse(function(L){if(!(L.isMesh||L.isPoints||L.isLine||L.isSprite))return;const j=L.material;if(j)if(Array.isArray(j))for(let re=0;re<j.length;re++){const ue=j[re];qe(ue,O,L),B.add(ue)}else qe(j,O,L),B.add(j)}),y.pop(),u=null,B},this.compileAsync=function(v,D,O=null){const B=this.compile(v,D,O);return new Promise(L=>{function j(){if(B.forEach(function(re){xe.get(re).currentProgram.isReady()&&B.delete(re)}),B.size===0){L(v);return}setTimeout(j,10)}Fe.get("KHR_parallel_shader_compile")!==null?j():setTimeout(j,10)})};let Ut=null;function $t(v){Ut&&Ut(v)}function As(){mn.stop()}function bs(){mn.start()}const mn=new Zr;mn.setAnimationLoop($t),typeof self<"u"&&mn.setContext(self),this.setAnimationLoop=function(v){Ut=v,H.setAnimationLoop(v),v===null?mn.stop():mn.start()},H.addEventListener("sessionstart",As),H.addEventListener("sessionend",bs),this.render=function(v,D){if(D!==void 0&&D.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),H.enabled===!0&&H.isPresenting===!0&&(H.cameraAutoUpdate===!0&&H.updateCamera(D),D=H.getCamera()),v.isScene===!0&&v.onBeforeRender(E,v,D,U),u=Ge.get(v,y.length),u.init(D),y.push(u),Te.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),q.setFromProjectionMatrix(Te),me=this.localClippingEnabled,ee=Q.init(this.clippingPlanes,me),f=he.get(v,A.length),f.init(),A.push(f),H.enabled===!0&&H.isPresenting===!0){const j=E.xr.getDepthSensingMesh();j!==null&&dr(j,D,-1/0,E.sortObjects)}dr(v,D,0,E.sortObjects),f.finish(),E.sortObjects===!0&&f.sort(ne,le),Be=H.enabled===!1||H.isPresenting===!1||H.hasDepthSensing()===!1,Be&&Ee.addToRenderList(f,v),this.info.render.frame++,ee===!0&&Q.beginShadows();const O=u.state.shadowsArray;de.render(O,v,D),ee===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const B=f.opaque,L=f.transmissive;if(u.setupLights(),D.isArrayCamera){const j=D.cameras;if(L.length>0)for(let re=0,ue=j.length;re<ue;re++){const pe=j[re];Cs(B,L,v,pe)}Be&&Ee.render(v);for(let re=0,ue=j.length;re<ue;re++){const pe=j[re];Rs(f,v,pe,pe.viewport)}}else L.length>0&&Cs(B,L,v,D),Be&&Ee.render(v),Rs(f,v,D);U!==null&&(T.updateMultisampleRenderTarget(U),T.updateRenderTargetMipmap(U)),v.isScene===!0&&v.onAfterRender(E,v,D),Ze.resetDefaultState(),S=-1,M=null,y.pop(),y.length>0?(u=y[y.length-1],ee===!0&&Q.setGlobalState(E.clippingPlanes,u.state.camera)):u=null,A.pop(),A.length>0?f=A[A.length-1]:f=null};function dr(v,D,O,B){if(v.visible===!1)return;if(v.layers.test(D.layers)){if(v.isGroup)O=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(D);else if(v.isLight)u.pushLight(v),v.castShadow&&u.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||q.intersectsSprite(v)){B&&Ue.setFromMatrixPosition(v.matrixWorld).applyMatrix4(Te);const re=X.update(v),ue=v.material;ue.visible&&f.push(v,re,ue,O,Ue.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||q.intersectsObject(v))){const re=X.update(v),ue=v.material;if(B&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Ue.copy(v.boundingSphere.center)):(re.boundingSphere===null&&re.computeBoundingSphere(),Ue.copy(re.boundingSphere.center)),Ue.applyMatrix4(v.matrixWorld).applyMatrix4(Te)),Array.isArray(ue)){const pe=re.groups;for(let Ae=0,be=pe.length;Ae<be;Ae++){const Me=pe[Ae],ze=ue[Me.materialIndex];ze&&ze.visible&&f.push(v,re,ze,O,Ue.z,Me)}}else ue.visible&&f.push(v,re,ue,O,Ue.z,null)}}const j=v.children;for(let re=0,ue=j.length;re<ue;re++)dr(j[re],D,O,B)}function Rs(v,D,O,B){const L=v.opaque,j=v.transmissive,re=v.transparent;u.setupLightsView(O),ee===!0&&Q.setGlobalState(E.clippingPlanes,O),B&&ve.viewport(w.copy(B)),L.length>0&&Ai(L,D,O),j.length>0&&Ai(j,D,O),re.length>0&&Ai(re,D,O),ve.buffers.depth.setTest(!0),ve.buffers.depth.setMask(!0),ve.buffers.color.setMask(!0),ve.setPolygonOffset(!1)}function Cs(v,D,O,B){if((O.isScene===!0?O.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[B.id]===void 0&&(u.state.transmissionRenderTarget[B.id]=new sn(1,1,{generateMipmaps:!0,type:Fe.has("EXT_color_buffer_half_float")||Fe.has("EXT_color_buffer_float")?1016:1009,minFilter:1008,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:He.workingColorSpace}));const j=u.state.transmissionRenderTarget[B.id],re=B.viewport||w;j.setSize(re.z,re.w);const ue=E.getRenderTarget();E.setRenderTarget(j),E.getClearColor(W),K=E.getClearAlpha(),K<1&&E.setClearColor(16777215,.5),E.clear(),Be&&Ee.render(O);const pe=E.toneMapping;E.toneMapping=0;const Ae=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),u.setupLightsView(B),ee===!0&&Q.setGlobalState(E.clippingPlanes,B),Ai(v,O,B),T.updateMultisampleRenderTarget(j),T.updateRenderTargetMipmap(j),Fe.has("WEBGL_multisampled_render_to_texture")===!1){let be=!1;for(let Me=0,ze=D.length;Me<ze;Me++){const We=D[Me],at=We.object,nt=We.geometry,Ve=We.material,Se=We.group;if(Ve.side===2&&at.layers.test(B.layers)){const ut=Ve.side;Ve.side=1,Ve.needsUpdate=!0,ws(at,O,B,nt,Ve,Se),Ve.side=ut,Ve.needsUpdate=!0,be=!0}}be===!0&&(T.updateMultisampleRenderTarget(j),T.updateRenderTargetMipmap(j))}E.setRenderTarget(ue),E.setClearColor(W,K),Ae!==void 0&&(B.viewport=Ae),E.toneMapping=pe}function Ai(v,D,O){const B=D.isScene===!0?D.overrideMaterial:null;for(let L=0,j=v.length;L<j;L++){const re=v[L],ue=re.object,pe=re.geometry,Ae=B===null?re.material:B,be=re.group;ue.layers.test(O.layers)&&ws(ue,D,O,pe,Ae,be)}}function ws(v,D,O,B,L,j){v.onBeforeRender(E,D,O,B,L,j),v.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),L.onBeforeRender(E,D,O,B,v,j),L.transparent===!0&&L.side===2&&L.forceSinglePass===!1?(L.side=1,L.needsUpdate=!0,E.renderBufferDirect(O,D,B,L,v,j),L.side=0,L.needsUpdate=!0,E.renderBufferDirect(O,D,B,L,v,j),L.side=2):E.renderBufferDirect(O,D,B,L,v,j),v.onAfterRender(E,D,O,B,L,j)}function bi(v,D,O){D.isScene!==!0&&(D=Qe);const B=xe.get(v),L=u.state.lights,j=u.state.shadowsArray,re=L.state.version,ue=_e.getParameters(v,L.state,j,D,O),pe=_e.getProgramCacheKey(ue);let Ae=B.programs;B.environment=v.isMeshStandardMaterial?D.environment:null,B.fog=D.fog,B.envMap=(v.isMeshStandardMaterial?F:g).get(v.envMap||B.environment),B.envMapRotation=B.environment!==null&&v.envMap===null?D.environmentRotation:v.envMapRotation,Ae===void 0&&(v.addEventListener("dispose",we),Ae=new Map,B.programs=Ae);let be=Ae.get(pe);if(be!==void 0){if(B.currentProgram===be&&B.lightsStateVersion===re)return Ds(v,ue),be}else ue.uniforms=_e.getUniforms(v),v.onBeforeCompile(ue,E),be=_e.acquireProgram(ue,pe),Ae.set(pe,be),B.uniforms=ue.uniforms;const Me=B.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Me.clippingPlanes=Q.uniform),Ds(v,ue),B.needsLights=Ru(v),B.lightsStateVersion=re,B.needsLights&&(Me.ambientLightColor.value=L.state.ambient,Me.lightProbe.value=L.state.probe,Me.directionalLights.value=L.state.directional,Me.directionalLightShadows.value=L.state.directionalShadow,Me.spotLights.value=L.state.spot,Me.spotLightShadows.value=L.state.spotShadow,Me.rectAreaLights.value=L.state.rectArea,Me.ltc_1.value=L.state.rectAreaLTC1,Me.ltc_2.value=L.state.rectAreaLTC2,Me.pointLights.value=L.state.point,Me.pointLightShadows.value=L.state.pointShadow,Me.hemisphereLights.value=L.state.hemi,Me.directionalShadowMap.value=L.state.directionalShadowMap,Me.directionalShadowMatrix.value=L.state.directionalShadowMatrix,Me.spotShadowMap.value=L.state.spotShadowMap,Me.spotLightMatrix.value=L.state.spotLightMatrix,Me.spotLightMap.value=L.state.spotLightMap,Me.pointShadowMap.value=L.state.pointShadowMap,Me.pointShadowMatrix.value=L.state.pointShadowMatrix),B.currentProgram=be,B.uniformsList=null,be}function Ps(v){if(v.uniformsList===null){const D=v.currentProgram.getUniforms();v.uniformsList=Ti.seqWithValue(D.seq,v.uniforms)}return v.uniformsList}function Ds(v,D){const O=xe.get(v);O.outputColorSpace=D.outputColorSpace,O.batching=D.batching,O.batchingColor=D.batchingColor,O.instancing=D.instancing,O.instancingColor=D.instancingColor,O.instancingMorph=D.instancingMorph,O.skinning=D.skinning,O.morphTargets=D.morphTargets,O.morphNormals=D.morphNormals,O.morphColors=D.morphColors,O.morphTargetsCount=D.morphTargetsCount,O.numClippingPlanes=D.numClippingPlanes,O.numIntersection=D.numClipIntersection,O.vertexAlphas=D.vertexAlphas,O.vertexTangents=D.vertexTangents,O.toneMapping=D.toneMapping}function Au(v,D,O,B,L){D.isScene!==!0&&(D=Qe),T.resetTextureUnits();const j=D.fog,re=B.isMeshStandardMaterial?D.environment:null,ue=U===null?E.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:gn,pe=(B.isMeshStandardMaterial?F:g).get(B.envMap||re),Ae=B.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,be=!!O.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Me=!!O.morphAttributes.position,ze=!!O.morphAttributes.normal,We=!!O.morphAttributes.color;let at=0;B.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(at=E.toneMapping);const nt=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,Ve=nt!==void 0?nt.length:0,Se=xe.get(B),ut=u.state.lights;if(ee===!0&&(me===!0||v!==M)){const _t=v===M&&B.id===S;Q.setState(B,v,_t)}let Xe=!1;B.version===Se.__version?(Se.needsLights&&Se.lightsStateVersion!==ut.state.version||Se.outputColorSpace!==ue||L.isBatchedMesh&&Se.batching===!1||!L.isBatchedMesh&&Se.batching===!0||L.isBatchedMesh&&Se.batchingColor===!0&&L.colorTexture===null||L.isBatchedMesh&&Se.batchingColor===!1&&L.colorTexture!==null||L.isInstancedMesh&&Se.instancing===!1||!L.isInstancedMesh&&Se.instancing===!0||L.isSkinnedMesh&&Se.skinning===!1||!L.isSkinnedMesh&&Se.skinning===!0||L.isInstancedMesh&&Se.instancingColor===!0&&L.instanceColor===null||L.isInstancedMesh&&Se.instancingColor===!1&&L.instanceColor!==null||L.isInstancedMesh&&Se.instancingMorph===!0&&L.morphTexture===null||L.isInstancedMesh&&Se.instancingMorph===!1&&L.morphTexture!==null||Se.envMap!==pe||B.fog===!0&&Se.fog!==j||Se.numClippingPlanes!==void 0&&(Se.numClippingPlanes!==Q.numPlanes||Se.numIntersection!==Q.numIntersection)||Se.vertexAlphas!==Ae||Se.vertexTangents!==be||Se.morphTargets!==Me||Se.morphNormals!==ze||Se.morphColors!==We||Se.toneMapping!==at||Se.morphTargetsCount!==Ve)&&(Xe=!0):(Xe=!0,Se.__version=B.version);let It=Se.currentProgram;Xe===!0&&(It=bi(B,D,L));let On=!1,Et=!1,jn=!1;const Je=It.getUniforms(),Rt=Se.uniforms;if(ve.useProgram(It.program)&&(On=!0,Et=!0,jn=!0),B.id!==S&&(S=B.id,Et=!0),On||M!==v){ve.buffers.depth.getReversed()?(se.copy(v.projectionMatrix),Fs(se),Ns(se),Je.setValue(b,"projectionMatrix",se)):Je.setValue(b,"projectionMatrix",v.projectionMatrix),Je.setValue(b,"viewMatrix",v.matrixWorldInverse);const xt=Je.map.cameraPosition;xt!==void 0&&xt.setValue(b,Re.setFromMatrixPosition(v.matrixWorld)),Ne.logarithmicDepthBuffer&&Je.setValue(b,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&Je.setValue(b,"isOrthographic",v.isOrthographicCamera===!0),M!==v&&(M=v,Et=!0,jn=!0)}if(L.isSkinnedMesh){Je.setOptional(b,L,"bindMatrix"),Je.setOptional(b,L,"bindMatrixInverse");const _t=L.skeleton;_t&&(_t.boneTexture===null&&_t.computeBoneTexture(),Je.setValue(b,"boneTexture",_t.boneTexture,T))}L.isBatchedMesh&&(Je.setOptional(b,L,"batchingTexture"),Je.setValue(b,"batchingTexture",L._matricesTexture,T),Je.setOptional(b,L,"batchingIdTexture"),Je.setValue(b,"batchingIdTexture",L._indirectTexture,T),Je.setOptional(b,L,"batchingColorTexture"),L._colorsTexture!==null&&Je.setValue(b,"batchingColorTexture",L._colorsTexture,T));const Ct=O.morphAttributes;if((Ct.position!==void 0||Ct.normal!==void 0||Ct.color!==void 0)&&ye.update(L,O,It),(Et||Se.receiveShadow!==L.receiveShadow)&&(Se.receiveShadow=L.receiveShadow,Je.setValue(b,"receiveShadow",L.receiveShadow)),B.isMeshGouraudMaterial&&B.envMap!==null&&(Rt.envMap.value=pe,Rt.flipEnvMap.value=pe.isCubeTexture&&pe.isRenderTargetTexture===!1?-1:1),B.isMeshStandardMaterial&&B.envMap===null&&D.environment!==null&&(Rt.envMapIntensity.value=D.environmentIntensity),Et&&(Je.setValue(b,"toneMappingExposure",E.toneMappingExposure),Se.needsLights&&bu(Rt,jn),j&&B.fog===!0&&ae.refreshFogUniforms(Rt,j),ae.refreshMaterialUniforms(Rt,B,z,J,u.state.transmissionRenderTarget[v.id]),Ti.upload(b,Ps(Se),Rt,T)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Ti.upload(b,Ps(Se),Rt,T),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&Je.setValue(b,"center",L.center),Je.setValue(b,"modelViewMatrix",L.modelViewMatrix),Je.setValue(b,"normalMatrix",L.normalMatrix),Je.setValue(b,"modelMatrix",L.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){const _t=B.uniformsGroups;for(let xt=0,fr=_t.length;xt<fr;xt++){const _n=_t[xt];P.update(_n,It),P.bind(_n,It)}}return It}function bu(v,D){v.ambientLightColor.needsUpdate=D,v.lightProbe.needsUpdate=D,v.directionalLights.needsUpdate=D,v.directionalLightShadows.needsUpdate=D,v.pointLights.needsUpdate=D,v.pointLightShadows.needsUpdate=D,v.spotLights.needsUpdate=D,v.spotLightShadows.needsUpdate=D,v.rectAreaLights.needsUpdate=D,v.hemisphereLights.needsUpdate=D}function Ru(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(v,D,O){xe.get(v.texture).__webglTexture=D,xe.get(v.depthTexture).__webglTexture=O;const B=xe.get(v);B.__hasExternalTextures=!0,B.__autoAllocateDepthBuffer=O===void 0,B.__autoAllocateDepthBuffer||Fe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),B.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(v,D){const O=xe.get(v);O.__webglFramebuffer=D,O.__useDefaultFramebuffer=D===void 0},this.setRenderTarget=function(v,D=0,O=0){U=v,C=D,R=O;let B=!0,L=null,j=!1,re=!1;if(v){const pe=xe.get(v);if(pe.__useDefaultFramebuffer!==void 0)ve.bindFramebuffer(b.FRAMEBUFFER,null),B=!1;else if(pe.__webglFramebuffer===void 0)T.setupRenderTarget(v);else if(pe.__hasExternalTextures)T.rebindTextures(v,xe.get(v.texture).__webglTexture,xe.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Me=v.depthTexture;if(pe.__boundDepthTexture!==Me){if(Me!==null&&xe.has(Me)&&(v.width!==Me.image.width||v.height!==Me.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");T.setupDepthRenderbuffer(v)}}const Ae=v.texture;(Ae.isData3DTexture||Ae.isDataArrayTexture||Ae.isCompressedArrayTexture)&&(re=!0);const be=xe.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(be[D])?L=be[D][O]:L=be[D],j=!0):v.samples>0&&T.useMultisampledRTT(v)===!1?L=xe.get(v).__webglMultisampledFramebuffer:Array.isArray(be)?L=be[O]:L=be,w.copy(v.viewport),V.copy(v.scissor),G=v.scissorTest}else w.copy(ge).multiplyScalar(z).floor(),V.copy(Le).multiplyScalar(z).floor(),G=Ke;if(ve.bindFramebuffer(b.FRAMEBUFFER,L)&&B&&ve.drawBuffers(v,L),ve.viewport(w),ve.scissor(V),ve.setScissorTest(G),j){const pe=xe.get(v.texture);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_CUBE_MAP_POSITIVE_X+D,pe.__webglTexture,O)}else if(re){const pe=xe.get(v.texture),Ae=D||0;b.framebufferTextureLayer(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,pe.__webglTexture,O||0,Ae)}S=-1},this.readRenderTargetPixels=function(v,D,O,B,L,j,re){if(!(v&&v.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ue=xe.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&re!==void 0&&(ue=ue[re]),ue){ve.bindFramebuffer(b.FRAMEBUFFER,ue);try{const pe=v.texture,Ae=pe.format,be=pe.type;if(!Ne.textureFormatReadable(Ae)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ne.textureTypeReadable(be)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=v.width-B&&O>=0&&O<=v.height-L&&b.readPixels(D,O,B,L,De.convert(Ae),De.convert(be),j)}finally{const pe=U!==null?xe.get(U).__webglFramebuffer:null;ve.bindFramebuffer(b.FRAMEBUFFER,pe)}}},this.readRenderTargetPixelsAsync=async function(v,D,O,B,L,j,re){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ue=xe.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&re!==void 0&&(ue=ue[re]),ue){const pe=v.texture,Ae=pe.format,be=pe.type;if(!Ne.textureFormatReadable(Ae))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ne.textureTypeReadable(be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(D>=0&&D<=v.width-B&&O>=0&&O<=v.height-L){ve.bindFramebuffer(b.FRAMEBUFFER,ue);const Me=b.createBuffer();b.bindBuffer(b.PIXEL_PACK_BUFFER,Me),b.bufferData(b.PIXEL_PACK_BUFFER,j.byteLength,b.STREAM_READ),b.readPixels(D,O,B,L,De.convert(Ae),De.convert(be),0);const ze=U!==null?xe.get(U).__webglFramebuffer:null;ve.bindFramebuffer(b.FRAMEBUFFER,ze);const We=b.fenceSync(b.SYNC_GPU_COMMANDS_COMPLETE,0);return b.flush(),await Is(b,We,4),b.bindBuffer(b.PIXEL_PACK_BUFFER,Me),b.getBufferSubData(b.PIXEL_PACK_BUFFER,0,j),b.deleteBuffer(Me),b.deleteSync(We),j}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(v,D=null,O=0){v.isTexture!==!0&&(xn("WebGLRenderer: copyFramebufferToTexture function signature has changed."),D=arguments[0]||null,v=arguments[1]);const B=Math.pow(2,-O),L=Math.floor(v.image.width*B),j=Math.floor(v.image.height*B),re=D!==null?D.x:0,ue=D!==null?D.y:0;T.setTexture2D(v,0),b.copyTexSubImage2D(b.TEXTURE_2D,O,0,0,re,ue,L,j),ve.unbindTexture()};const Cu=b.createFramebuffer(),wu=b.createFramebuffer();this.copyTextureToTexture=function(v,D,O=null,B=null,L=0,j=null){v.isTexture!==!0&&(xn("WebGLRenderer: copyTextureToTexture function signature has changed."),B=arguments[0]||null,v=arguments[1],D=arguments[2],j=arguments[3]||0,O=null),j===null&&(L!==0?(xn("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),j=L,L=0):j=0);let re,ue,pe,Ae,be,Me,ze,We,at;const nt=v.isCompressedTexture?v.mipmaps[j]:v.image;if(O!==null)re=O.max.x-O.min.x,ue=O.max.y-O.min.y,pe=O.isBox3?O.max.z-O.min.z:1,Ae=O.min.x,be=O.min.y,Me=O.isBox3?O.min.z:0;else{const Ct=Math.pow(2,-L);re=Math.floor(nt.width*Ct),ue=Math.floor(nt.height*Ct),v.isDataArrayTexture?pe=nt.depth:v.isData3DTexture?pe=Math.floor(nt.depth*Ct):pe=1,Ae=0,be=0,Me=0}B!==null?(ze=B.x,We=B.y,at=B.z):(ze=0,We=0,at=0);const Ve=De.convert(D.format),Se=De.convert(D.type);let ut;D.isData3DTexture?(T.setTexture3D(D,0),ut=b.TEXTURE_3D):D.isDataArrayTexture||D.isCompressedArrayTexture?(T.setTexture2DArray(D,0),ut=b.TEXTURE_2D_ARRAY):(T.setTexture2D(D,0),ut=b.TEXTURE_2D),b.pixelStorei(b.UNPACK_FLIP_Y_WEBGL,D.flipY),b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),b.pixelStorei(b.UNPACK_ALIGNMENT,D.unpackAlignment);const Xe=b.getParameter(b.UNPACK_ROW_LENGTH),It=b.getParameter(b.UNPACK_IMAGE_HEIGHT),On=b.getParameter(b.UNPACK_SKIP_PIXELS),Et=b.getParameter(b.UNPACK_SKIP_ROWS),jn=b.getParameter(b.UNPACK_SKIP_IMAGES);b.pixelStorei(b.UNPACK_ROW_LENGTH,nt.width),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,nt.height),b.pixelStorei(b.UNPACK_SKIP_PIXELS,Ae),b.pixelStorei(b.UNPACK_SKIP_ROWS,be),b.pixelStorei(b.UNPACK_SKIP_IMAGES,Me);const Je=v.isDataArrayTexture||v.isData3DTexture,Rt=D.isDataArrayTexture||D.isData3DTexture;if(v.isDepthTexture){const Ct=xe.get(v),_t=xe.get(D),xt=xe.get(Ct.__renderTarget),fr=xe.get(_t.__renderTarget);ve.bindFramebuffer(b.READ_FRAMEBUFFER,xt.__webglFramebuffer),ve.bindFramebuffer(b.DRAW_FRAMEBUFFER,fr.__webglFramebuffer);for(let _n=0;_n<pe;_n++)Je&&(b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,xe.get(v).__webglTexture,L,Me+_n),b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,xe.get(D).__webglTexture,j,at+_n)),b.blitFramebuffer(Ae,be,re,ue,ze,We,re,ue,b.DEPTH_BUFFER_BIT,b.NEAREST);ve.bindFramebuffer(b.READ_FRAMEBUFFER,null),ve.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else if(L!==0||v.isRenderTargetTexture||xe.has(v)){const Ct=xe.get(v),_t=xe.get(D);ve.bindFramebuffer(b.READ_FRAMEBUFFER,Cu),ve.bindFramebuffer(b.DRAW_FRAMEBUFFER,wu);for(let xt=0;xt<pe;xt++)Je?b.framebufferTextureLayer(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,Ct.__webglTexture,L,Me+xt):b.framebufferTexture2D(b.READ_FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,Ct.__webglTexture,L),Rt?b.framebufferTextureLayer(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,_t.__webglTexture,j,at+xt):b.framebufferTexture2D(b.DRAW_FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,_t.__webglTexture,j),L!==0?b.blitFramebuffer(Ae,be,re,ue,ze,We,re,ue,b.COLOR_BUFFER_BIT,b.NEAREST):Rt?b.copyTexSubImage3D(ut,j,ze,We,at+xt,Ae,be,re,ue):b.copyTexSubImage2D(ut,j,ze,We,Ae,be,re,ue);ve.bindFramebuffer(b.READ_FRAMEBUFFER,null),ve.bindFramebuffer(b.DRAW_FRAMEBUFFER,null)}else Rt?v.isDataTexture||v.isData3DTexture?b.texSubImage3D(ut,j,ze,We,at,re,ue,pe,Ve,Se,nt.data):D.isCompressedArrayTexture?b.compressedTexSubImage3D(ut,j,ze,We,at,re,ue,pe,Ve,nt.data):b.texSubImage3D(ut,j,ze,We,at,re,ue,pe,Ve,Se,nt):v.isDataTexture?b.texSubImage2D(b.TEXTURE_2D,j,ze,We,re,ue,Ve,Se,nt.data):v.isCompressedTexture?b.compressedTexSubImage2D(b.TEXTURE_2D,j,ze,We,nt.width,nt.height,Ve,nt.data):b.texSubImage2D(b.TEXTURE_2D,j,ze,We,re,ue,Ve,Se,nt);b.pixelStorei(b.UNPACK_ROW_LENGTH,Xe),b.pixelStorei(b.UNPACK_IMAGE_HEIGHT,It),b.pixelStorei(b.UNPACK_SKIP_PIXELS,On),b.pixelStorei(b.UNPACK_SKIP_ROWS,Et),b.pixelStorei(b.UNPACK_SKIP_IMAGES,jn),j===0&&D.generateMipmaps&&b.generateMipmap(ut),ve.unbindTexture()},this.copyTextureToTexture3D=function(v,D,O=null,B=null,L=0){return v.isTexture!==!0&&(xn("WebGLRenderer: copyTextureToTexture3D function signature has changed."),O=arguments[0]||null,B=arguments[1]||null,v=arguments[2],D=arguments[3],L=arguments[4]||0),xn('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(v,D,O,B,L)},this.initRenderTarget=function(v){xe.get(v).__webglFramebuffer===void 0&&T.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?T.setTextureCube(v,0):v.isData3DTexture?T.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?T.setTexture2DArray(v,0):T.setTexture2D(v,0),ve.unbindTexture()},this.resetState=function(){C=0,R=0,U=null,ve.reset(),Ze.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return 2e3}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=He._getDrawingBufferColorSpace(e),t.unpackColorSpace=He._getUnpackColorSpace()}}const Eu=`
...
`;function yu({imageUrl:i="",particleTextureUrl:e="https://res.cloudinary.com/dfvtkoboz/image/upload/v1605013866/particle_a64uzf.png",particleSize:t=5,particleArea:n=5e4,particleAmount:r=1e5,ease:s=.5,cameraConfig:a={fov:65,near:1,far:1e4,position:[0,0,800]},backgroundColor:o=2236962,style:l={}}){const c=Kt.useRef(null),h=Kt.useRef(null);Kt.useEffect(()=>{if(h.current)return;const m=new qr;let _=null;return m.onLoad=function(){h.current=new d(_)},_=new pa(m).load(e),()=>{h.current&&(h.current.dispose(),h.current=null)}},[e]);class d{constructor(_){this.particle=_,this.container=c.current,this.scene=new sa,this.scene.background=new ke(o),this.createCamera(),this.createRenderer(),this.setup(),this.bindEvents()}setup(){this.createParticles=new p(this.scene,this.particle,this.camera,this.renderer)}bindEvents(){window.addEventListener("resize",this.onWindowResize.bind(this))}createCamera(){const{fov:_,near:x,far:f,position:u}=a;this.camera=new At(_,this.container.clientWidth/this.container.clientHeight,x,f),this.camera.position.set(...u)}createRenderer(){this.renderer=new Su({antialias:!0}),this.renderer.setSize(this.container.clientWidth,this.container.clientHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.container.appendChild(this.renderer.domElement),this.renderer.setAnimationLoop(()=>{this.render()})}render(){this.createParticles.render(),this.renderer.render(this.scene,this.camera)}onWindowResize(){this.camera.aspect=this.container.clientWidth/this.container.clientHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(this.container.clientWidth,this.container.clientHeight)}dispose(){window.removeEventListener("resize",this.onWindowResize),this.renderer.dispose()}}class p{constructor(_,x,f,u){this.scene=_,this.particleImg=x,this.camera=f,this.renderer=u,this.raycaster=new ga,this.mouse=new $e(-200,200),this.currenPosition=new N,this.isMouseDown=!1,this.images=[i],this.data={amount:r,particleSize:t,area:n,ease:s},this.currentImageIndex=0;const A=new Kn(this.visibleWidthAtZDepth(100,this.camera),this.visibleHeightAtZDepth(100,this.camera)),y=new Zi({color:65280,transparent:!0,opacity:0});this.planeArea=new Ot(A,y),this.scene.add(this.planeArea),this.loadImageAndCreateParticles(this.images[this.currentImageIndex]);const E=this.renderer.domElement;E.addEventListener("mousedown",this.onMouseDown.bind(this)),E.addEventListener("mousemove",this.onMouseMove.bind(this)),E.addEventListener("mouseup",this.onMouseUp.bind(this))}loadImageAndCreateParticles(_){const x=new Image;x.crossOrigin="Anonymous",x.src=_,x.onload=()=>{const f=document.createElement("canvas"),u=f.getContext("2d");f.width=x.width,f.height=x.height,u.drawImage(x,0,0);const A=u.getImageData(0,0,f.width,f.height),y=this.createGeometryFromImageData(A);this.particles&&(this.scene.remove(this.particles),this.particles.geometry.dispose(),this.particles.material.dispose());const E=new Yt({uniforms:{color:{value:new ke(16777215)},pointTexture:{value:this.particleImg}},vertexShader:Eu,fragmentShader:Tu,blending:2,depthTest:!1,transparent:!0});this.particles=new ca(y,E),this.scene.add(this.particles),this.geometryCopy=new Nt,this.geometryCopy.copy(this.particles.geometry)}}createGeometryFromImageData(_){const{width:x,height:f,data:u}=_,A=[],y=[],E=[];let I=Math.floor(Math.sqrt(x*f/this.data.amount));I<1&&(I=1);for(let R=0;R<f;R+=I)for(let U=0;U<x;U+=I){const S=(R*x+U)*4,M=u[S],w=u[S+1],V=u[S+2];if(u[S+3]>50){const W=U-x/2,K=-(R-f/2);A.push(new N(W,K,0)),y.push(M/255,w/255,V/255),E.push(this.data.particleSize)}}const C=new Nt().setFromPoints(A);return C.setAttribute("customColor",new qt(y,3)),C.setAttribute("size",new qt(E,1)),C}onMouseDown(_){this.isMouseDown=!0,this.data.ease=.01,this.updateMousePosition(_),this.updateCurrentPosition()}onMouseUp(){this.isMouseDown=!1,this.data.ease=s}onMouseMove(_){const x=this.renderer.domElement.getBoundingClientRect();this.mouse.x=(_.clientX-x.left)/x.width*2-1,this.mouse.y=-((_.clientY-x.top)/x.height)*2+1}updateMousePosition(_){const x=this.renderer.domElement.getBoundingClientRect();this.mouse.x=(_.clientX-x.left)/x.width*2-1,this.mouse.y=-((_.clientY-x.top)/x.height)*2+1}updateCurrentPosition(){const _=new N(this.mouse.x,this.mouse.y,.5);_.unproject(this.camera);const x=_.sub(this.camera.position).normalize(),f=-this.camera.position.z/x.z;this.currenPosition.copy(this.camera.position.clone().add(x.multiplyScalar(f)))}render(){if(!this.particles||!this.geometryCopy)return;const _=this.particles.geometry.attributes.position,x=this.geometryCopy.attributes.position,f=this.particles.geometry.attributes.size,u=_.array,A=x.array,y=f.array;this.raycaster.setFromCamera(this.mouse,this.camera);const E=this.raycaster.intersectObject(this.planeArea);let I=null,C=null;E.length>0&&(I=E[0].point.x,C=E[0].point.y);for(let R=0;R<_.count;R++){const U=R*3,S=A[U],M=A[U+1],w=A[U+2];let V=u[U],G=u[U+1],W=u[U+2];if(I!==null&&C!==null){const K=I-V,k=C-G,J=K*K+k*k,z=-this.data.area/J;if(this.isMouseDown){const ne=Math.atan2(k,K);V-=z*Math.cos(ne),G-=z*Math.sin(ne)}else if(Math.sqrt(J)<this.data.area){const le=Math.atan2(k,K);R%5===0?(V-=.03*Math.cos(le),G-=.03*Math.sin(le),y[R]=this.data.particleSize/1.2):(V+=z*Math.cos(le),G+=z*Math.sin(le),y[R]=this.data.particleSize*1.3)}}V+=(S-V)*this.data.ease,G+=(M-G)*this.data.ease,W+=(w-W)*this.data.ease,u[U]=V,u[U+1]=G,u[U+2]=W}_.needsUpdate=!0,f.needsUpdate=!0}visibleHeightAtZDepth(_,x){const f=x.position.z;_<f?_-=f:_+=f;const u=x.fov*Math.PI/180;return 2*Math.tan(u/2)*Math.abs(_)}visibleWidthAtZDepth(_,x){return this.visibleHeightAtZDepth(_,x)*x.aspect}}return Kt.createElement("div",{ref:c,style:{width:"100%",height:"100%",...l}})}rn.MagicParticles=yu,Object.defineProperty(rn,Symbol.toStringTag,{value:"Module"})});
